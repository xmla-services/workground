...
@ServiceProvider(value = FunctionResolver.class, attribute = { "function.definition:String='AggregateFun'" })
@Component(service = FunctionResolver.class, scope = ServiceScope.SINGLETON)
public class AggregateFunDefResolver extends ReflectiveMultiResolver {
    public AggregateFunDefResolver(
    ) {
