...
public abstract class AbstractSchemaWalker {
    ...
    void checkCube(Cube cube1) {
    }

    void checkNamedSetList(List<? extends NamedSet> namedSet) {
        if (namedSet != null) {
    ...
    void checkNamedSet(NamedSet ns) {

    }

    void checkVirtualCube(VirtualCube virtualcube1) {
    }

    void checkUserDefinedFunction(UserDefinedFunction userdefinedfunction1) {
    }
