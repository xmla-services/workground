...
public interface SchemaReader {
    ...
    Member getMemberByUniqueName(
        List<IIdSegment> uniqueNameParts,
    ...
    */
     ...
     */
    Member getCalculatedMember(List<IIdSegment> nameParts);

    /**
     * Looks up a set by name. If the name is not found in the current scope,
     * returns null.
     */
    NamedSet getNamedSet(List<IIdSegment> nameParts);
    ...
    List<Member> lookupMemberChildrenByNames(
        Member parent,
        List<IIdNameSegment> childNames,
        MatchType matchType);
