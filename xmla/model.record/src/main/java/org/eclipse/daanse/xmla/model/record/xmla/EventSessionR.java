...
public record EventSessionR(String templateCategory,
                            ...
                            String name,
                            BigInteger maxMemory,
                            RetentionModes eventRetentionMode,
                            Long dispatchLatency,
                            Long maxEventSize,
                            PartitionModes memoryPartitionMode,
                            Boolean trackCausality) implements EventSession {
