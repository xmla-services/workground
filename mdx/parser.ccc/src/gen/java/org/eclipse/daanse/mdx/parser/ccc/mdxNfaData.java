/* Generated by: CongoCC Parser Generator. mdxNfaData.java */
...
class mdxNfaData implements mdxConstants {
    ...
    */
    private static class DEFAULT {
        ...
        static private TokenType NFA_0(int ch, BitSet nextStates, EnumSet<TokenType> validTypes) {
            ...
            } else if (((ch == '$') || ((ch >= 'A' && ch <= 'Z') || ((ch == '_') || (ch >= 'a' && ch <= 'z')))) || (ch >= 128 && checkIntervals(NFA_MOVES_492, ch))) {
                nextStates.set(195);
        ...
        static private TokenType NFA_195(int ch, BitSet nextStates, EnumSet<TokenType> validTypes) {
            TokenType type = null;
            if (((ch == '$') || ((ch >= 'A' && ch <= 'Z') || ((ch == '_') || (ch >= 'a' && ch <= 'z')))) || (ch >= 128 && checkIntervals(NFA_MOVES_506, ch))) {
                nextStates.set(195);
                if (validTypes.contains(ID)) type = ID;
            }
            if ((ch >= '0' && ch <= '9') || (ch >= 128 && checkIntervals(NFA_MOVES_450, ch))) {
                nextStates.set(195);
                if (validTypes.contains(ID)) type = ID;
            }
            return type;
        ...
        static private TokenType NFA_344(int ch, BitSet nextStates, EnumSet<TokenType> validTypes) {
            TokenType type = null;
            if (((ch == '$') || ((ch >= 'A' && ch <= 'Z') || ((ch == '_') || (ch >= 'a' && ch <= 'z')))) || (ch >= 128 && checkIntervals(NFA_MOVES_140, ch))) {
                nextStates.set(344);
                if (validTypes.contains(AMP_UNQUOTED_ID)) type = AMP_UNQUOTED_ID;
            }
            if ((ch >= '0' && ch <= '9') || (ch >= 128 && checkIntervals(NFA_MOVES_443, ch))) {
                nextStates.set(344);
                if (validTypes.contains(AMP_UNQUOTED_ID)) type = AMP_UNQUOTED_ID;
            }
            return type;
    ...
    */
    private static class IN_FORMAL_COMMENT {
        ...
        static private void NFA_FUNCTIONS_init() {
            NfaFunction[] functions = new NfaFunction[] {IN_FORMAL_COMMENT::NFA_IN_FORMAL_COMMENT_0, IN_FORMAL_COMMENT::NFA_IN_FORMAL_COMMENT_1};
