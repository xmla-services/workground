...
import org.eclipse.daanse.core.api.olap.IFunInfo;
import org.eclipse.daanse.core.api.olap.Syntax;
 ...
 */
public interface ResolverTable {
    /**
     ...
     *
     * <p>An implementation of {@link ResolverTable} must register all
     * of its functions and operators by making callbacks during its
     * {@link ResolverTable#defineFunctions(ResolverTable.Builder)}
     * method.
     */
