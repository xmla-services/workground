...
public class MDXParser implements mdxConstants {
    ...
    */
    ...
    MdxStatement parseMdxStatement() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:436:3
            pushOntoCallStack("parseMdxStatement", "ccc/mdx.ccc", 436, 3);
            try {
                mdxStatement = parseSelectStatement();
            } finally {
                popCallStack();
            }
            // Code for EndOfFile specified at ccc/mdx.ccc:449:3
            consumeToken(EOF);
            // Code for CodeBlock specified at ccc/mdx.ccc:450:3
            return mdxStatement;
    ...
    final public DrillthroughStatement parseDrillthroughStatement() {
        ...
        try {
            // Code for RegexpRef specified at ccc/mdx.ccc:461:3
            ...
            if (nextTokenType() == MAXROWS) {
                ...
                // Code for RegexpRef specified at ccc/mdx.ccc:462:16
            ...
            if (nextTokenType() == FIRSTROWSET) {
                ...
                // Code for RegexpRef specified at ccc/mdx.ccc:463:20
                consumeToken(UNSIGNED_INTEGER_LITERAL);
            }
            // Code for NonTerminal specified at ccc/mdx.ccc:464:3
            pushOntoCallStack("parseDrillthroughStatement", "ccc/mdx.ccc", 464, 3);
            try {
                selectStatement = parseSelectStatement();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrOne specified at ccc/mdx.ccc:465:3
            if (nextTokenType() == RETURN) {
                // Code for RegexpRef specified at ccc/mdx.ccc:466:5
                consumeToken(RETURN);
                // Code for NonTerminal specified at ccc/mdx.ccc:466:16
                pushOntoCallStack("parseDrillthroughStatement", "ccc/mdx.ccc", 466, 16);
                try {
            ...
            // Code for CodeBlock specified at ccc/mdx.ccc:468:3
    ...
    final public List<ReturnItem> parseReturnItems() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:479:3
            pushOntoCallStack("parseReturnItems", "ccc/mdx.ccc", 479, 3);
            try {
                item = parseReturnItem();
            } finally {
                popCallStack();
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:480:3
            returnItems.add(item);
            // Code for ZeroOrMore specified at ccc/mdx.ccc:483:3
            while (true) {
                if (!(nextTokenType() == COMMA)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:484:5
                consumeToken(COMMA);
                // Code for NonTerminal specified at ccc/mdx.ccc:484:15
                pushOntoCallStack("parseReturnItems", "ccc/mdx.ccc", 484, 15);
                try {
                    item = parseReturnItem();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:485:5
                returnItems.add(item);
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:489:3
            return returnItems;
        } catch (ParseException e) {
            parseException82 = e;
            throw e;
    ...
    final public ReturnItem parseReturnItem() {
        ...
        try {
            ...
            pushOntoCallStack("parseReturnItem", "ccc/mdx.ccc", 499, 3);
            try {
    ...
    SelectWithClause parseSelectWithClause() {
        ...
        try {
            if (nextTokenType() == MEMBER || nextTokenType == CALCULATED) {
                // Code for ZeroOrOne specified at ccc/mdx.ccc:517:5
                if (nextTokenType() == CALCULATED) {
                    // Code for RegexpStringLiteral specified at ccc/mdx.ccc:517:6
                    consumeToken(CALCULATED);
                }
                // Code for RegexpRef specified at ccc/mdx.ccc:517:21
                consumeToken(MEMBER);
                // Code for NonTerminal specified at ccc/mdx.ccc:517:32
                pushOntoCallStack("parseSelectWithClause", "ccc/mdx.ccc", 517, 32);
                try {
                ...
                // Code for RegexpRef specified at ccc/mdx.ccc:518:5
                consumeToken(SET);
                // Code for NonTerminal specified at ccc/mdx.ccc:518:13
                pushOntoCallStack("parseSelectWithClause", "ccc/mdx.ccc", 518, 13);
                try {
                ...
                pushOntoCallStack("parseSelectWithClause", "ccc/mdx.ccc", 517, 5);
                throw new ParseException(this, first_set$mdx_ccc$517$5, parsingStack);
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:521:3
    ...
    final public SelectStatement parseSelectStatement() {
        ...
        try {
            // Code for ZeroOrOne specified at ccc/mdx.ccc:535:3
            if (nextTokenType() == WITH) {
                // Code for RegexpRef specified at ccc/mdx.ccc:536:5
                consumeToken(WITH);
                // Code for OneOrMore specified at ccc/mdx.ccc:537:5
                while (true) {
                    // Code for NonTerminal specified at ccc/mdx.ccc:538:7
                    pushOntoCallStack("parseSelectStatement", "ccc/mdx.ccc", 538, 7);
                    try {
                        selectWithClause = parseSelectWithClause();
                    } finally {
                        popCallStack();
            ...
            if (nextTokenType() == ASTERISK) {
                // Code for NonTerminal specified at ccc/mdx.ccc:543:5
                pushOntoCallStack("parseSelectStatement", "ccc/mdx.ccc", 543, 5);
                try {
                    selectQueryClause = parseSelectQueryAsteriskClause();
                } finally {
                    popCallStack();
                }
            } else if (first_set$mdx_ccc$545$5.contains(nextTokenType())) {
                // Code for NonTerminal specified at ccc/mdx.ccc:545:5
                pushOntoCallStack("parseSelectStatement", "ccc/mdx.ccc", 545, 5);
                try {
                ...
                // Code for CodeBlock specified at ccc/mdx.ccc:547:5
                selectQueryClause = new SelectQueryEmptyClause();
            }
            // Code for RegexpRef specified at ccc/mdx.ccc:551:3
            consumeToken(FROM);
            // Code for NonTerminal specified at ccc/mdx.ccc:551:12
            pushOntoCallStack("parseSelectStatement", "ccc/mdx.ccc", 551, 12);
            try {
                selectSubcubeClause = parseSelectSubcubeClause();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrOne specified at ccc/mdx.ccc:552:3
            if (nextTokenType() == WHERE) {
                // Code for NonTerminal specified at ccc/mdx.ccc:553:5
                pushOntoCallStack("parseSelectStatement", "ccc/mdx.ccc", 553, 5);
                try {
            ...
            // Code for ZeroOrOne specified at ccc/mdx.ccc:555:3
            if (nextTokenType() == CELL || nextTokenType == PROPERTIES) {
                // Code for NonTerminal specified at ccc/mdx.ccc:556:5
                pushOntoCallStack("parseSelectStatement", "ccc/mdx.ccc", 556, 5);
                try {
    ...
    final public SelectSubcubeClause parseSelectSubcubeClause() {
        ...
        try {
            if (first_set$mdx_ccc$569$5.contains(nextTokenType())) {
                // Code for NonTerminal specified at ccc/mdx.ccc:569:5
                pushOntoCallStack("parseSelectSubcubeClause", "ccc/mdx.ccc", 569, 5);
                try {
                ...
                pushOntoCallStack("parseSelectSubcubeClause", "ccc/mdx.ccc", 571, 5);
                try {
                ...
                pushOntoCallStack("parseSelectSubcubeClause", "ccc/mdx.ccc", 569, 5);
                throw new ParseException(this, first_set$mdx_ccc$569$5$, parsingStack);
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:573:3
    ...
    final public SelectSubcubeClauseName parseSelectSubcubeClauseName() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:583:3
            pushOntoCallStack("parseSelectSubcubeClauseName", "ccc/mdx.ccc", 583, 3);
            try {
                nameObjectIdentifier = parseNameObjectIdentifier();
            } finally {
                popCallStack();
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:584:3
    ...
    final public SelectSubcubeClauseStatement parseSelectSubcubeClauseStatement() {
        ...
        try {
            // Code for RegexpRef specified at ccc/mdx.ccc:597:5
            consumeToken(LPAREN);
            // Code for RegexpRef specified at ccc/mdx.ccc:597:16
            consumeToken(SELECT);
            // Code for ZeroOrOne specified at ccc/mdx.ccc:598:5
            // Code for ExpansionChoice specified at ccc/mdx.ccc:599:7
            if (nextTokenType() == ASTERISK) {
                // Code for NonTerminal specified at ccc/mdx.ccc:599:7
                pushOntoCallStack("parseSelectSubcubeClauseStatement", "ccc/mdx.ccc", 599, 7);
                try {
                    selectQueryClause = parseSelectQueryAsteriskClause();
                } finally {
                    popCallStack();
                }
            } else if (first_set$mdx_ccc$601$7.contains(nextTokenType())) {
                // Code for NonTerminal specified at ccc/mdx.ccc:601:7
                pushOntoCallStack("parseSelectSubcubeClauseStatement", "ccc/mdx.ccc", 601, 7);
                try {
                    selectQueryClause = parseSelectQueryAxesClause();
                } finally {
                    popCallStack();
            ...
            // Code for RegexpRef specified at ccc/mdx.ccc:603:5
            consumeToken(FROM);
            // Code for NonTerminal specified at ccc/mdx.ccc:603:14
            pushOntoCallStack("parseSelectSubcubeClauseStatement", "ccc/mdx.ccc", 603, 14);
            try {
                selectSubcubeClause = parseSelectSubcubeClause();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrOne specified at ccc/mdx.ccc:604:5
            if (nextTokenType() == WHERE) {
                // Code for NonTerminal specified at ccc/mdx.ccc:605:7
                pushOntoCallStack("parseSelectSubcubeClauseStatement", "ccc/mdx.ccc", 605, 7);
                try {
                    selectSlicerAxisClause = parseSelectSlicerAxisClause();
                } finally {
                    popCallStack();
            ...
            // Code for RegexpRef specified at ccc/mdx.ccc:607:5
            consumeToken(RPAREN);
            // Code for CodeBlock specified at ccc/mdx.ccc:609:3
    ...
    final public SelectQueryAsteriskClause parseSelectQueryAsteriskClause() {
        ...
        try {
            // Code for RegexpRef specified at ccc/mdx.ccc:616:3
            consumeToken(ASTERISK);
            // Code for CodeBlock specified at ccc/mdx.ccc:617:3
    ...
    final public SelectQueryAxesClause parseSelectQueryAxesClause() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:628:3
            pushOntoCallStack("parseSelectQueryAxesClause", "ccc/mdx.ccc", 628, 3);
            try {
                selectQueryAxisClause = parseSelectQueryAxisClause();
            } finally {
                popCallStack();
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:629:3
            selectQueryAxisClauses.add(selectQueryAxisClause);
            // Code for ZeroOrMore specified at ccc/mdx.ccc:632:3
            while (true) {
                if (!(nextTokenType() == COMMA)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:633:5
                consumeToken(COMMA);
                // Code for NonTerminal specified at ccc/mdx.ccc:633:15
                pushOntoCallStack("parseSelectQueryAxesClause", "ccc/mdx.ccc", 633, 15);
                try {
                    selectQueryAxisClause = parseSelectQueryAxisClause();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:634:5
                selectQueryAxisClauses.add(selectQueryAxisClause);
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:638:3
    ...
    final public SelectSlicerAxisClause parseSelectSlicerAxisClause() {
        ...
        try {
            // Code for RegexpRef specified at ccc/mdx.ccc:648:3
            consumeToken(WHERE);
            // Code for NonTerminal specified at ccc/mdx.ccc:648:13
            pushOntoCallStack("parseSelectSlicerAxisClause", "ccc/mdx.ccc", 648, 13);
            try {
                expression = parseExpression();
            } finally {
                popCallStack();
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:649:3
    ...
    final public SelectCellPropertyListClause parseSelectCellPropertyListClause() {
        ...
        try {
            // Code for ZeroOrOne specified at ccc/mdx.ccc:659:3
            if (nextTokenType() == CELL) {
                // Code for RegexpRef specified at ccc/mdx.ccc:659:4
                consumeToken(CELL);
            }
            // Code for RegexpRef specified at ccc/mdx.ccc:659:15
            consumeToken(PROPERTIES);
            // Code for NonTerminal specified at ccc/mdx.ccc:659:30
            pushOntoCallStack("parseSelectCellPropertyListClause", "ccc/mdx.ccc", 659, 30);
            try {
                parseCellProperty();
            } finally {
                popCallStack();
            ...
            while (true) {
                ...
                pushOntoCallStack("parseSelectCellPropertyListClause", "ccc/mdx.ccc", 661, 15);
                try {
                    parseCellProperty();
                } finally {
                    popCallStack();
    ...
    final public CreateMemberBodyClause parseCreateMemberBodyClause() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:670:3
            pushOntoCallStack("parseCreateMemberBodyClause", "ccc/mdx.ccc", 670, 3);
            try {
                parseIdentifier();
            } finally {
                popCallStack();
            }
            // Code for RegexpRef specified at ccc/mdx.ccc:670:19
            consumeToken(AS);
            // Code for NonTerminal specified at ccc/mdx.ccc:670:26
            pushOntoCallStack("parseCreateMemberBodyClause", "ccc/mdx.ccc", 670, 26);
            try {
                parseFormulaExpression();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrMore specified at ccc/mdx.ccc:671:3
            while (true) {
                if (!(nextTokenType() == COMMA)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:672:5
                consumeToken(COMMA);
                // Code for NonTerminal specified at ccc/mdx.ccc:672:15
                pushOntoCallStack("parseCreateMemberBodyClause", "ccc/mdx.ccc", 672, 15);
                try {
            ...
            // Code for CodeBlock specified at ccc/mdx.ccc:674:3
    ...
    final public MemberPropertyDefinition parseMemberPropertyDefinition() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:681:3
            pushOntoCallStack("parseMemberPropertyDefinition", "ccc/mdx.ccc", 681, 3);
            try {
                parseIdentifier();
            } finally {
                popCallStack();
            }
            // Code for RegexpRef specified at ccc/mdx.ccc:681:19
            consumeToken(EQ);
            // Code for NonTerminal specified at ccc/mdx.ccc:681:26
            pushOntoCallStack("parseMemberPropertyDefinition", "ccc/mdx.ccc", 681, 26);
            try {
                parseExpression();
            } finally {
                popCallStack();
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:682:3
    ...
    final public FormulaExpression parseFormulaExpression() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:689:3
            pushOntoCallStack("parseFormulaExpression", "ccc/mdx.ccc", 689, 3);
            try {
                parseIdentifier();
            } finally {
                popCallStack();
            }
            // Code for RegexpRef specified at ccc/mdx.ccc:689:19
            consumeToken(EQ);
            // Code for NonTerminal specified at ccc/mdx.ccc:689:26
            pushOntoCallStack("parseFormulaExpression", "ccc/mdx.ccc", 689, 26);
            try {
                parseIdentifier();
            } finally {
                popCallStack();
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:690:3
    ...
    final public Expression parseExpression() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:701:3
            pushOntoCallStack("parseExpression", "ccc/mdx.ccc", 701, 3);
            try {
                expression = unaliasedExpression();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrMore specified at ccc/mdx.ccc:702:3
            while (true) {
                if (!(nextTokenType() == AS)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:703:5
                consumeToken(AS);
                // Code for NonTerminal specified at ccc/mdx.ccc:703:12
                pushOntoCallStack("parseExpression", "ccc/mdx.ccc", 703, 12);
                try {
                    objectIdentifier = parseIdentifier();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:704:5
            ...
            // Code for CodeBlock specified at ccc/mdx.ccc:712:3
            return expression;
        } catch (ParseException e) {
            parseException570 = e;
            throw e;
    ...
    final public Expression expressionOrEmpty() {
        ...
        // Code for ExpansionChoice specified at ccc/mdx.ccc:722:3
        ...
        try {
            if (first_set$mdx_ccc$722$3.contains(nextTokenType())) {
                // Code for NonTerminal specified at ccc/mdx.ccc:722:3
                pushOntoCallStack("expressionOrEmpty", "ccc/mdx.ccc", 722, 3);
                try {
                    expression = parseExpression();
                } finally {
                    popCallStack();
    ...
    List<Expression> expOrEmptyList() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:741:3
            pushOntoCallStack("expOrEmptyList", "ccc/mdx.ccc", 741, 3);
            try {
                expression = expressionOrEmpty();
            } finally {
                popCallStack();
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:742:3
            list.add(expression);
            // Code for ZeroOrMore specified at ccc/mdx.ccc:745:3
            while (true) {
                if (!(nextTokenType() == COMMA)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:746:5
                consumeToken(COMMA);
                // Code for NonTerminal specified at ccc/mdx.ccc:747:5
                pushOntoCallStack("expOrEmptyList", "ccc/mdx.ccc", 747, 5);
                try {
                    expression = expressionOrEmpty();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:748:5
                list.add(expression);
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:752:3
            return list;
        } catch (ParseException e) {
            parseException626 = e;
            throw e;
    ...
    List<Expression> expList() {
        ...
        try {
            ...
            pushOntoCallStack("expList", "ccc/mdx.ccc", 764, 3);
            try {
                expression = parseExpression();
            } finally {
                popCallStack();
            ...
            list.add(expression);
            // Code for ZeroOrMore specified at ccc/mdx.ccc:768:3
            while (true) {
                if (!(nextTokenType() == COMMA)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:769:5
                consumeToken(COMMA);
                // Code for NonTerminal specified at ccc/mdx.ccc:770:5
                pushOntoCallStack("expList", "ccc/mdx.ccc", 770, 5);
                try {
                    expression = parseExpression();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:771:5
                list.add(expression);
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:775:3
            return list;
        } catch (ParseException e) {
            parseException662 = e;
            throw e;
    ...
    final public Expression expressionEof() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:785:3
            pushOntoCallStack("expressionEof", "ccc/mdx.ccc", 785, 3);
            try {
                expression = parseExpression();
            } finally {
                popCallStack();
            }
            // Code for EndOfFile specified at ccc/mdx.ccc:785:32
            consumeToken(EOF);
            // Code for CodeBlock specified at ccc/mdx.ccc:786:3
            return expression;
        } catch (ParseException e) {
            parseException698 = e;
            throw e;
    ...
    final public ObjectIdentifier parseIdentifier() {
        ...
        try {
            if (first_set$mdx_ccc$797$5.contains(nextTokenType())) {
                // Code for NonTerminal specified at ccc/mdx.ccc:797:5
                pushOntoCallStack("parseIdentifier", "ccc/mdx.ccc", 797, 5);
                try {
                ...
                // Code for NonTerminal specified at ccc/mdx.ccc:799:5
                pushOntoCallStack("parseIdentifier", "ccc/mdx.ccc", 799, 5);
                try {
                ...
                pushOntoCallStack("parseIdentifier", "ccc/mdx.ccc", 797, 5);
                throw new ParseException(this, first_set$mdx_ccc$797$5$, parsingStack);
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:801:3
    ...
    final public NameObjectIdentifier parseNameObjectIdentifier() {
        ...
        // Code for ExpansionChoice specified at ccc/mdx.ccc:811:3
        ...
        try {
            if (nextTokenType() == DIMENSION || nextTokenType == PROPERTIES) {
                // Code for NonTerminal specified at ccc/mdx.ccc:811:3
                pushOntoCallStack("parseNameObjectIdentifier", "ccc/mdx.ccc", 811, 3);
                try {
                    id = parseKeyword();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:812:3
                ...
                // Code for RegexpRef specified at ccc/mdx.ccc:816:3
                consumeToken(ID);
                ...
                // Code for RegexpRef specified at ccc/mdx.ccc:820:3
                consumeToken(ATSIGN);
                // Code for RegexpRef specified at ccc/mdx.ccc:820:14
                consumeToken(ID);
                // Code for CodeBlock specified at ccc/mdx.ccc:821:3
                return new NameObjectIdentifier("@" + getToken(0).getImage(), ObjectIdentifier.Quoting.UNQUOTED);
            } else if (nextTokenType() == QUOTED_ID) {
                // Code for RegexpRef specified at ccc/mdx.ccc:824:3
                consumeToken(QUOTED_ID);
                // Code for CodeBlock specified at ccc/mdx.ccc:825:3
    ...
    KeyObjectIdentifier parseKeyIdentifier() {
        ...
        try {
            // Code for OneOrMore specified at ccc/mdx.ccc:839:3
            while (true) {
                // Code for NonTerminal specified at ccc/mdx.ccc:840:5
                pushOntoCallStack("parseKeyIdentifier", "ccc/mdx.ccc", 840, 5);
                try {
                    key = parseAmpId();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:841:5
                list.add(key);
                if (!(nextTokenType() == AMP_QUOTED_ID || nextTokenType == AMP_UNQUOTED_ID)) break;
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:845:3
    ...
    String parseKeyword() {
        ...
        try {
            if (nextTokenType() == DIMENSION) {
                ...
                pushOntoCallStack("parseKeyword", "ccc/mdx.ccc", 871, 5);
                throw new ParseException(this, first_set$mdx_ccc$871$5, parsingStack);
            }
    ...
    final public CompoundId parseCompoundId() {
        ...
        try {
            ...
            pushOntoCallStack("parseCompoundId", "ccc/mdx.ccc", 886, 3);
            try {
                s = parseIdentifier();
            } finally {
                popCallStack();
            ...
            list.add(s);
            // Code for ZeroOrMore specified at ccc/mdx.ccc:890:3
            while (true) {
                if (!(scan$mdx_ccc$891$5())) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:892:5
                consumeToken(DOT);
                // Code for NonTerminal specified at ccc/mdx.ccc:892:13
                pushOntoCallStack("parseCompoundId", "ccc/mdx.ccc", 892, 13);
                try {
                    s = parseIdentifier();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:893:5
                list.add(s);
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:897:3
    ...
    Expression unaliasedExpression() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:909:3
            pushOntoCallStack("unaliasedExpression", "ccc/mdx.ccc", 909, 3);
            try {
                x = term5();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrMore specified at ccc/mdx.ccc:910:3
            while (true) {
                // Code for ExpansionChoice specified at ccc/mdx.ccc:911:5
                if (nextTokenType() == OR) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:911:5
                    consumeToken(OR);
                    // Code for NonTerminal specified at ccc/mdx.ccc:911:12
                    pushOntoCallStack("unaliasedExpression", "ccc/mdx.ccc", 911, 12);
                    try {
                        y = term5();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:912:5
                    x = new CallExpression("OR", CallExpression.Type.Term_Infix, List.of(x, y));
                } else if (nextTokenType() == XOR) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:918:5
                    consumeToken(XOR);
                    // Code for NonTerminal specified at ccc/mdx.ccc:918:13
                    pushOntoCallStack("unaliasedExpression", "ccc/mdx.ccc", 918, 13);
                    try {
                        y = term5();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:919:5
                    x = new CallExpression("XOR", CallExpression.Type.Term_Infix, List.of(x, y));
                } else if (nextTokenType() == COLON) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:927:5
                    consumeToken(COLON);
                    // Code for NonTerminal specified at ccc/mdx.ccc:927:15
                    pushOntoCallStack("unaliasedExpression", "ccc/mdx.ccc", 927, 15);
                    try {
                        y = term5();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:928:5
    ...
    final public Expression term5() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:945:3
            pushOntoCallStack("term5", "ccc/mdx.ccc", 945, 3);
            try {
                x = term4();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrMore specified at ccc/mdx.ccc:946:3
            while (true) {
                if (!(nextTokenType() == AND)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:947:5
                consumeToken(AND);
                // Code for NonTerminal specified at ccc/mdx.ccc:947:13
                pushOntoCallStack("term5", "ccc/mdx.ccc", 947, 13);
                try {
                    y = term4();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:948:5
                x = new CallExpression("AND", CallExpression.Type.Term_Infix, List.of(x, y));
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:955:3
            return x;
        } catch (ParseException e) {
            parseException984 = e;
            throw e;
    ...
    final public Expression term4() {
        ...
        // Code for ExpansionChoice specified at ccc/mdx.ccc:965:3
        ...
        try {
            if (first_set$mdx_ccc$965$3.contains(nextTokenType())) {
                // Code for NonTerminal specified at ccc/mdx.ccc:965:3
                pushOntoCallStack("term4", "ccc/mdx.ccc", 965, 3);
                try {
                    x = term3();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:966:3
                return x;
            } else if (nextTokenType() == NOT) {
                // Code for RegexpRef specified at ccc/mdx.ccc:969:3
                consumeToken(NOT);
                // Code for NonTerminal specified at ccc/mdx.ccc:969:11
                pushOntoCallStack("term4", "ccc/mdx.ccc", 969, 11);
                try {
                    x = term4();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:970:3
    ...
    final public Expression term3() {
        ...
        try {
            ...
            pushOntoCallStack("term3", "ccc/mdx.ccc", 984, 3);
            try {
                x = term2();
            } finally {
                popCallStack();
            ...
            while (true) {
                // Code for ExpansionChoice specified at ccc/mdx.ccc:987:5
                if (first_set$mdx_ccc$987$5.contains(nextTokenType())) {
                    if (nextTokenType() == EQ) {
                        // Code for RegexpRef specified at ccc/mdx.ccc:988:7
                        consumeToken(EQ);
                        // Code for CodeBlock specified at ccc/mdx.ccc:989:7
                        op = getToken(0);
                    } else if (nextTokenType() == NE) {
                        // Code for RegexpRef specified at ccc/mdx.ccc:992:7
                        consumeToken(NE);
                        // Code for CodeBlock specified at ccc/mdx.ccc:993:7
                        op = getToken(0);
                    } else if (nextTokenType() == LT) {
                        // Code for RegexpRef specified at ccc/mdx.ccc:996:7
                        consumeToken(LT);
                        // Code for CodeBlock specified at ccc/mdx.ccc:997:7
                        op = getToken(0);
                    } else if (nextTokenType() == GT) {
                        // Code for RegexpRef specified at ccc/mdx.ccc:1000:7
                        consumeToken(GT);
                        // Code for CodeBlock specified at ccc/mdx.ccc:1001:7
                        op = getToken(0);
                    } else if (nextTokenType() == LE) {
                        // Code for RegexpRef specified at ccc/mdx.ccc:1004:7
                        consumeToken(LE);
                        // Code for CodeBlock specified at ccc/mdx.ccc:1005:7
                        op = getToken(0);
                    } else if (nextTokenType() == GE) {
                        // Code for RegexpRef specified at ccc/mdx.ccc:1008:7
                        consumeToken(GE);
                        // Code for CodeBlock specified at ccc/mdx.ccc:1009:7
                        op = getToken(0);
                    } else {
                        pushOntoCallStack("term3", "ccc/mdx.ccc", 988, 7);
                        throw new ParseException(this, first_set$mdx_ccc$988$7, parsingStack);
                    }
                    // Code for NonTerminal specified at ccc/mdx.ccc:1013:5
                    pushOntoCallStack("term3", "ccc/mdx.ccc", 1013, 5);
                    try {
                        y = term2();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:1014:5
                    x = new CallExpression(op.getImage(), CallExpression.Type.Term_Infix, List.of(x, y));
                } else if (scan$mdx_ccc$1023$5()) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1024:5
                    consumeToken(IS);
                    // Code for RegexpRef specified at ccc/mdx.ccc:1024:12
                    consumeToken(NULL);
                    // Code for CodeBlock specified at ccc/mdx.ccc:1025:5
                    x = new CallExpression("IS NULL", CallExpression.Type.Term_Postfix, List.of(x));
                } else if (scan$mdx_ccc$1033$5()) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1034:5
                    consumeToken(IS);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1034:12
                    pushOntoCallStack("term3", "ccc/mdx.ccc", 1034, 12);
                    try {
                        y = term2();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:1035:5
                    x = new CallExpression("IS", CallExpression.Type.Term_Infix, List.of(x, y));
                } else if (nextTokenType() == IS) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1041:5
                    consumeToken(IS);
                    // Code for RegexpRef specified at ccc/mdx.ccc:1041:12
                    consumeToken(EMPTY);
                    // Code for CodeBlock specified at ccc/mdx.ccc:1042:5
                    x = new CallExpression("IS EMPTY", CallExpression.Type.Term_Postfix, List.of(x));
                } else if (nextTokenType() == MATCHES) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1046:5
                    consumeToken(MATCHES);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1046:17
                    pushOntoCallStack("term3", "ccc/mdx.ccc", 1046, 17);
                    try {
                        y = term2();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:1047:5
                    x = new CallExpression("MATCHES", CallExpression.Type.Term_Infix, List.of(x, y));
                } else if (scan$mdx_ccc$1053$5()) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1054:5
                    consumeToken(NOT);
                    // Code for RegexpRef specified at ccc/mdx.ccc:1054:13
                    consumeToken(MATCHES);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1054:25
                    pushOntoCallStack("term3", "ccc/mdx.ccc", 1054, 25);
                    try {
                        y = term2();
                    } finally {
                        popCallStack();
                    ...
                    // Code for RegexpRef specified at ccc/mdx.ccc:1066:5
                    consumeToken(IN);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1066:12
                    pushOntoCallStack("term3", "ccc/mdx.ccc", 1066, 12);
                    try {
                        y = term2();
                    } finally {
                        popCallStack();
                    ...
                    // Code for RegexpRef specified at ccc/mdx.ccc:1073:5
                    consumeToken(NOT);
                    // Code for RegexpRef specified at ccc/mdx.ccc:1073:13
                    consumeToken(IN);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1073:20
                    pushOntoCallStack("term3", "ccc/mdx.ccc", 1073, 20);
                    try {
                        y = term2();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:1074:5
            ...
            // Code for CodeBlock specified at ccc/mdx.ccc:1086:3
            return x;
        } catch (ParseException e) {
    ...
    final public Expression term2() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:1096:3
            pushOntoCallStack("term2", "ccc/mdx.ccc", 1096, 3);
            try {
                x = term();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrMore specified at ccc/mdx.ccc:1097:3
            while (true) {
                // Code for ExpansionChoice specified at ccc/mdx.ccc:1098:5
                if (nextTokenType() == PLUS) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1098:5
                    consumeToken(PLUS);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1098:14
                    pushOntoCallStack("term2", "ccc/mdx.ccc", 1098, 14);
                    try {
                        y = term();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:1099:5
                    x = new CallExpression("+", CallExpression.Type.Term_Infix, List.of(x, y));
                } else if (nextTokenType() == MINUS) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1105:5
                    consumeToken(MINUS);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1105:15
                    pushOntoCallStack("term2", "ccc/mdx.ccc", 1105, 15);
                    try {
                        y = term();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:1106:5
                    x = new CallExpression("-", CallExpression.Type.Term_Infix, List.of(x, y));
                } else if (nextTokenType() == CONCAT) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1112:5
                    consumeToken(CONCAT);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1112:16
                    pushOntoCallStack("term2", "ccc/mdx.ccc", 1112, 16);
                    try {
                        y = term();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:1113:5
                    x = new CallExpression("||", CallExpression.Type.Term_Infix, List.of(x, y));
                } else {
                    break;
                }
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:1120:3
            return x;
        } catch (ParseException e) {
    ...
    final public Expression term() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:1130:3
            pushOntoCallStack("term", "ccc/mdx.ccc", 1130, 3);
            try {
                x = factor();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrMore specified at ccc/mdx.ccc:1131:3
            while (true) {
                // Code for ExpansionChoice specified at ccc/mdx.ccc:1132:5
                if (nextTokenType() == ASTERISK) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1132:5
                    consumeToken(ASTERISK);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1132:18
                    pushOntoCallStack("term", "ccc/mdx.ccc", 1132, 18);
                    try {
                        y = factor();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:1133:5
                    x = new CallExpression("*", CallExpression.Type.Term_Infix, List.of(x, y));
                } else if (nextTokenType() == SOLIDUS) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1139:5
                    consumeToken(SOLIDUS);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1139:17
                    pushOntoCallStack("term", "ccc/mdx.ccc", 1139, 17);
                    try {
                        y = factor();
                    } finally {
                        popCallStack();
            ...
            // Code for CodeBlock specified at ccc/mdx.ccc:1147:3
            return x;
        } catch (ParseException e) {
    ...
    final public Expression factor() {
        ...
        // Code for ExpansionChoice specified at ccc/mdx.ccc:1157:3
        ...
        try {
            if (first_set$mdx_ccc$1157$3.contains(nextTokenType())) {
                // Code for NonTerminal specified at ccc/mdx.ccc:1157:3
                pushOntoCallStack("factor", "ccc/mdx.ccc", 1157, 3);
                try {
                    p = primary();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:1158:3
                return p;
            } else if (nextTokenType() == PLUS) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1161:3
                consumeToken(PLUS);
                // Code for NonTerminal specified at ccc/mdx.ccc:1161:12
                pushOntoCallStack("factor", "ccc/mdx.ccc", 1161, 12);
                try {
                    p = primary();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:1162:3
                return p;
            } else if (nextTokenType() == MINUS) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1165:3
                consumeToken(MINUS);
                // Code for NonTerminal specified at ccc/mdx.ccc:1165:13
                pushOntoCallStack("factor", "ccc/mdx.ccc", 1165, 13);
                try {
                    p = primary();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:1166:3
                return new CallExpression("-", CallExpression.Type.Term_Prefix, List.of(p));
            } else if (nextTokenType() == EXISTING) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1172:3
                consumeToken(EXISTING);
                // Code for NonTerminal specified at ccc/mdx.ccc:1172:16
                pushOntoCallStack("factor", "ccc/mdx.ccc", 1172, 16);
                try {
                    p = primary();
                } finally {
                    popCallStack();
    ...
    final public Expression primary() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:1186:3
            pushOntoCallStack("primary", "ccc/mdx.ccc", 1186, 3);
            try {
                expression = atom();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrMore specified at ccc/mdx.ccc:1187:3
            while (true) {
                if (!(nextTokenType() == DOT)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:1188:5
                consumeToken(DOT);
                // Code for NonTerminal specified at ccc/mdx.ccc:1188:13
                pushOntoCallStack("primary", "ccc/mdx.ccc", 1188, 13);
                try {
            ...
            // Code for CodeBlock specified at ccc/mdx.ccc:1190:3
            return expression;
        } catch (ParseException e) {
    ...
    final public Expression objectIdentifierOrFuncall(Expression left) {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:1201:3
            pushOntoCallStack("objectIdentifierOrFuncall", "ccc/mdx.ccc", 1201, 3);
            try {
                objectIdentifier = parseIdentifier();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrOne specified at ccc/mdx.ccc:1202:3
            if (nextTokenType() == LPAREN) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1203:5
                consumeToken(LPAREN);
                if (scan$mdx_ccc$1205$7()) {
                    // Code for CodeBlock specified at ccc/mdx.ccc:1206:7
                    argList = Collections.emptyList();
                } else {
                    // Code for NonTerminal specified at ccc/mdx.ccc:1210:7
                    pushOntoCallStack("objectIdentifierOrFuncall", "ccc/mdx.ccc", 1210, 7);
                    try {
                ...
                // Code for RegexpRef specified at ccc/mdx.ccc:1212:5
                consumeToken(RPAREN);
            }
    ...
    final public NumericLiteral parseNumericLiteral() {
        ...
        // Code for ExpansionChoice specified at ccc/mdx.ccc:1221:3
        ...
        try {
            if (nextTokenType() == DECIMAL_NUMERIC_LITERAL) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1221:3
                ...
                // Code for RegexpRef specified at ccc/mdx.ccc:1229:3
                consumeToken(APPROX_NUMERIC_LITERAL);
                // Code for CodeBlock specified at ccc/mdx.ccc:1230:3
                return new NumericLiteral(new BigDecimal(getToken(0).getImage()));
            } else {
                pushOntoCallStack("parseNumericLiteral", "ccc/mdx.ccc", 1221, 3);
    ...
    final public Expression atom() {
        ...
        // Code for ExpansionChoice specified at ccc/mdx.ccc:1242:3
        ASTatom atom38 = null;
        if (buildTree) {
            atom38 = new ASTatom();
        ...
        try {
            if (nextTokenType() == SINGLE_QUOTED_STRING) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1242:3
                ...
                // Code for RegexpRef specified at ccc/mdx.ccc:1246:3
                consumeToken(DOUBLE_QUOTED_STRING);
                // Code for CodeBlock specified at ccc/mdx.ccc:1247:3
                return new StringLiteral(stripQuotes(getToken(0).getImage(), '"' + "", '"' + "", '"' + "" + '"'));
                ...
                // Code for NonTerminal specified at ccc/mdx.ccc:1250:3
                pushOntoCallStack("atom", "ccc/mdx.ccc", 1250, 3);
                try {
                    expression = parseNumericLiteral();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:1251:3
                return expression;
            } else if (nextTokenType() == NULL) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1254:3
                consumeToken(NULL);
                ...
                consumeToken(CAST);
                // Code for RegexpRef specified at ccc/mdx.ccc:1258:12
                consumeToken(LPAREN);
                // Code for NonTerminal specified at ccc/mdx.ccc:1258:23
                pushOntoCallStack("atom", "ccc/mdx.ccc", 1258, 23);
                try {
                    expression = unaliasedExpression();
                } finally {
                    popCallStack();
                ...
                consumeToken(AS);
                // Code for NonTerminal specified at ccc/mdx.ccc:1259:10
                pushOntoCallStack("atom", "ccc/mdx.ccc", 1259, 10);
                try {
                    nameObjectIdentifier = parseNameObjectIdentifier();
                } finally {
                    popCallStack();
                }
                // Code for RegexpRef specified at ccc/mdx.ccc:1259:59
                consumeToken(RPAREN);
                // Code for CodeBlock specified at ccc/mdx.ccc:1260:3
                return new CallExpression("CAST", CallExpression.Type.Cast, List.of(expression, new SymbolLiteral(nameObjectIdentifier.name())));
            } else if (nextTokenType() == LPAREN) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1268:3
                consumeToken(LPAREN);
                // Code for NonTerminal specified at ccc/mdx.ccc:1268:14
                pushOntoCallStack("atom", "ccc/mdx.ccc", 1268, 14);
                try {
                    expressions = expList();
                } finally {
                    popCallStack();
                }
                // Code for RegexpRef specified at ccc/mdx.ccc:1268:36
                consumeToken(RPAREN);
                // Code for CodeBlock specified at ccc/mdx.ccc:1269:3
                ...
                // Code for RegexpRef specified at ccc/mdx.ccc:1277:3
                consumeToken(LBRACE);
                if (scan$mdx_ccc$1279$5()) {
                    // Code for CodeBlock specified at ccc/mdx.ccc:1280:5
                    expressions = Collections.emptyList();
                } else if (first_set$mdx_ccc$1284$5.contains(nextTokenType())) {
                    // Code for NonTerminal specified at ccc/mdx.ccc:1284:5
                    pushOntoCallStack("atom", "ccc/mdx.ccc", 1284, 5);
                    try {
                        expressions = expList();
                    } finally {
                        popCallStack();
                    ...
                    pushOntoCallStack("atom", "ccc/mdx.ccc", 1279, 5);
                    throw new ParseException(this, first_set$mdx_ccc$1279$5, parsingStack);
                }
                // Code for RegexpRef specified at ccc/mdx.ccc:1286:3
                consumeToken(RBRACE);
                // Code for CodeBlock specified at ccc/mdx.ccc:1287:3
                ...
                return expression;
            } else if (first_set$mdx_ccc$1298$3.contains(nextTokenType())) {
                // Code for NonTerminal specified at ccc/mdx.ccc:1298:3
                pushOntoCallStack("atom", "ccc/mdx.ccc", 1298, 3);
                try {
                ...
                // Code for ZeroOrMore specified at ccc/mdx.ccc:1299:3
                while (true) {
                    if (!(nextTokenType() == BANG)) break;
                    // Code for RegexpRef specified at ccc/mdx.ccc:1300:5
                    consumeToken(BANG);
                    // Code for NonTerminal specified at ccc/mdx.ccc:1300:14
                    pushOntoCallStack("atom", "ccc/mdx.ccc", 1300, 14);
                    try {
                        nameObjectIdentifier = parseNameObjectIdentifier();
                    } finally {
                        popCallStack();
                    }
                    // Code for CodeBlock specified at ccc/mdx.ccc:1301:5
                ...
                if (nextTokenType() == LPAREN) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1309:5
                    consumeToken(LPAREN);
                    if (scan$mdx_ccc$1311$7()) {
                        // Code for CodeBlock specified at ccc/mdx.ccc:1312:7
                        expressions = Collections.emptyList();
                    } else {
                        // Code for NonTerminal specified at ccc/mdx.ccc:1316:7
                        pushOntoCallStack("atom", "ccc/mdx.ccc", 1316, 7);
                        try {
                    ...
                    // Code for RegexpRef specified at ccc/mdx.ccc:1318:5
                    consumeToken(RPAREN);
                } else {
                    // Code for CodeBlock specified at ccc/mdx.ccc:1320:16
                    expressions = null;
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:1324:3
                return createCall(null, nameObjectIdentifier, expressions);
            } else {
                pushOntoCallStack("atom", "ccc/mdx.ccc", 1242, 3);
    ...
    final public Expression caseExpression() {
        ...
        try {
            // Code for RegexpRef specified at ccc/mdx.ccc:1336:3
            consumeToken(CASE);
            // Code for ZeroOrOne specified at ccc/mdx.ccc:1337:3
            if (first_set$mdx_ccc$1338$5.contains(nextTokenType())) {
                // Code for NonTerminal specified at ccc/mdx.ccc:1338:5
                pushOntoCallStack("caseExpression", "ccc/mdx.ccc", 1338, 5);
                try {
                    expression = parseExpression();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:1339:5
                match = true;
                expressions.add(expression);
            }
            // Code for ZeroOrMore specified at ccc/mdx.ccc:1344:3
            while (true) {
                if (!(nextTokenType() == WHEN)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:1345:5
                consumeToken(WHEN);
                // Code for NonTerminal specified at ccc/mdx.ccc:1345:14
                pushOntoCallStack("caseExpression", "ccc/mdx.ccc", 1345, 14);
                try {
                    expression = parseExpression();
                } finally {
                    popCallStack();
                }
                // Code for RegexpRef specified at ccc/mdx.ccc:1345:43
                consumeToken(THEN);
                // Code for NonTerminal specified at ccc/mdx.ccc:1345:52
                pushOntoCallStack("caseExpression", "ccc/mdx.ccc", 1345, 52);
                try {
                    expression2 = parseExpression();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:1346:5
                expressions.add(expression);
                expressions.add(expression2);
            }
            // Code for ZeroOrOne specified at ccc/mdx.ccc:1351:3
            if (nextTokenType() == ELSE) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1352:5
                consumeToken(ELSE);
                // Code for NonTerminal specified at ccc/mdx.ccc:1352:14
                pushOntoCallStack("caseExpression", "ccc/mdx.ccc", 1352, 14);
                try {
                    expression = parseExpression();
                } finally {
                    popCallStack();
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:1353:5
                expressions.add(expression);
            }
            // Code for RegexpRef specified at ccc/mdx.ccc:1357:3
            consumeToken(END);
            // Code for CodeBlock specified at ccc/mdx.ccc:1358:3
            if (match) {
    ...
    final public CellProperty parseCellProperty() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:1374:3
            pushOntoCallStack("parseCellProperty", "ccc/mdx.ccc", 1374, 3);
            try {
                parseIdentifier();
            } finally {
                popCallStack();
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:1375:3
    ...
    final public CreateSetBodyClause parseCreateSetBodyClause() {
        ...
        try {
            // Code for NonTerminal specified at ccc/mdx.ccc:1382:3
            pushOntoCallStack("parseCreateSetBodyClause", "ccc/mdx.ccc", 1382, 3);
            try {
                parseIdentifier();
            } finally {
                popCallStack();
            }
            // Code for RegexpRef specified at ccc/mdx.ccc:1382:19
            consumeToken(AS);
            // Code for NonTerminal specified at ccc/mdx.ccc:1382:26
            pushOntoCallStack("parseCreateSetBodyClause", "ccc/mdx.ccc", 1382, 26);
            try {
                parseIdentifier();
            } finally {
                popCallStack();
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:1383:3
    ...
    final public SelectDimensionPropertyListClause parseSelectDimensionPropertyListClause() {
        ...
        try {
            ...
            if (nextTokenType() == DIMENSION) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1390:4
                consumeToken(DIMENSION);
            }
            // Code for RegexpRef specified at ccc/mdx.ccc:1390:20
            consumeToken(PROPERTIES);
            // Code for NonTerminal specified at ccc/mdx.ccc:1391:3
            pushOntoCallStack("parseSelectDimensionPropertyListClause", "ccc/mdx.ccc", 1391, 3);
            try {
                parseIdentifier();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrMore specified at ccc/mdx.ccc:1392:3
            while (true) {
                if (!(nextTokenType() == COMMA)) break;
                // Code for RegexpRef specified at ccc/mdx.ccc:1393:5
                consumeToken(COMMA);
                // Code for NonTerminal specified at ccc/mdx.ccc:1393:15
                pushOntoCallStack("parseSelectDimensionPropertyListClause", "ccc/mdx.ccc", 1393, 15);
                try {
                    parseIdentifier();
                } finally {
                    popCallStack();
            ...
            // Code for CodeBlock specified at ccc/mdx.ccc:1395:3
    ...
    SelectQueryAxisClause parseSelectQueryAxisClause() {
        ...
        try {
            // Code for ZeroOrOne specified at ccc/mdx.ccc:1410:3
            if (nextTokenType() == NON) {
                // Code for RegexpRef specified at ccc/mdx.ccc:1410:4
                consumeToken(NON);
                // Code for RegexpRef specified at ccc/mdx.ccc:1410:12
                consumeToken(EMPTY);
                // Code for CodeBlock specified at ccc/mdx.ccc:1411:3
                nonEmpty = true;
            }
            // Code for NonTerminal specified at ccc/mdx.ccc:1415:3
            pushOntoCallStack("parseSelectQueryAxisClause", "ccc/mdx.ccc", 1415, 3);
            try {
                expression = parseExpression();
            } finally {
                popCallStack();
            }
            // Code for ZeroOrOne specified at ccc/mdx.ccc:1416:3
            if (nextTokenType() == DIMENSION || nextTokenType == PROPERTIES) {
                // Code for NonTerminal specified at ccc/mdx.ccc:1417:5
                pushOntoCallStack("parseSelectQueryAxisClause", "ccc/mdx.ccc", 1417, 5);
                try {
            ...
            // Code for RegexpRef specified at ccc/mdx.ccc:1419:3
            consumeToken(ON);
            if (nextTokenType() == AXIS || nextTokenType == UNSIGNED_INTEGER_LITERAL) {
                if (nextTokenType() == UNSIGNED_INTEGER_LITERAL) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1422:7
                    consumeToken(UNSIGNED_INTEGER_LITERAL);
                    // Code for CodeBlock specified at ccc/mdx.ccc:1423:7
                    n = Integer.valueOf(getToken(0).getImage()).intValue();
                } else if (nextTokenType() == AXIS) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1426:7
                    consumeToken(AXIS);
                    // Code for RegexpRef specified at ccc/mdx.ccc:1426:16
                    consumeToken(LPAREN);
                    // Code for RegexpRef specified at ccc/mdx.ccc:1426:27
                    consumeToken(UNSIGNED_INTEGER_LITERAL);
                    // Code for CodeBlock specified at ccc/mdx.ccc:1427:7
                    n = Integer.valueOf(getToken(0).getImage()).intValue();
                    // Code for RegexpRef specified at ccc/mdx.ccc:1430:7
                    consumeToken(RPAREN);
                } else {
                    pushOntoCallStack("parseSelectQueryAxisClause", "ccc/mdx.ccc", 1422, 7);
                    throw new ParseException(this, first_set$mdx_ccc$1422$7, parsingStack);
                }
                // Code for CodeBlock specified at ccc/mdx.ccc:1432:5
                if (n < 0) {
                    throw new IllegalArgumentException("Only axis numbers >= 0 allowed.");
                } else {
                    axis = Axis.create(n);
                }
            } else if (first_set$mdx_ccc$1443$5.contains(nextTokenType())) {
                if (nextTokenType() == COLUMNS) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1444:7
                    consumeToken(COLUMNS);
                    // Code for CodeBlock specified at ccc/mdx.ccc:1445:7
                    axis = Axis.COLUMNS;
                } else if (nextTokenType() == ROWS) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1448:7
                    consumeToken(ROWS);
                    // Code for CodeBlock specified at ccc/mdx.ccc:1449:7
                    axis = Axis.ROWS;
                } else if (nextTokenType() == PAGES) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1452:7
                    consumeToken(PAGES);
                    // Code for CodeBlock specified at ccc/mdx.ccc:1453:7
                    axis = Axis.PAGES;
                } else if (nextTokenType() == SECTIONS) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1456:7
                    consumeToken(SECTIONS);
                    // Code for CodeBlock specified at ccc/mdx.ccc:1457:7
                    axis = Axis.SECTIONS;
                } else if (nextTokenType() == CHAPTERS) {
                    // Code for RegexpRef specified at ccc/mdx.ccc:1460:7
                    consumeToken(CHAPTERS);
                    // Code for CodeBlock specified at ccc/mdx.ccc:1461:7
                    axis = Axis.CHAPTERS;
                } else {
                    pushOntoCallStack("parseSelectQueryAxisClause", "ccc/mdx.ccc", 1444, 7);
                    throw new ParseException(this, first_set$mdx_ccc$1444$7, parsingStack);
                }
            } else {
                pushOntoCallStack("parseSelectQueryAxisClause", "ccc/mdx.ccc", 1421, 5);
                throw new ParseException(this, first_set$mdx_ccc$1421$5, parsingStack);
            }
            // Code for CodeBlock specified at ccc/mdx.ccc:1466:3
    ...
    static private final EnumSet<TokenType> first_set$mdx_ccc$517$5 = tokenTypeSet(MEMBER, SET, CALCULATED);
    static private final EnumSet<TokenType> first_set$mdx_ccc$545$5 = first_set$mdx_ccc$545$5_init();

    static private EnumSet<TokenType> first_set$mdx_ccc$545$5_init() {
    ...
    static private final EnumSet<TokenType> first_set$mdx_ccc$569$5$ = tokenTypeSet(DIMENSION, PROPERTIES, LPAREN, ATSIGN, ID, QUOTED_ID);
    static private final EnumSet<TokenType> first_set$mdx_ccc$569$5 = tokenTypeSet(DIMENSION, PROPERTIES, ATSIGN, ID, QUOTED_ID);
    static private final EnumSet<TokenType> first_set$mdx_ccc$601$7 = first_set$mdx_ccc$601$7_init();

    static private EnumSet<TokenType> first_set$mdx_ccc$601$7_init() {
        return tokenTypeSet(CASE, CAST, DIMENSION, NON, NOT, NULL, PROPERTIES, EXISTING, LPAREN, LBRACE, MINUS, PLUS, ATSIGN, ID, QUOTED_ID, UNSIGNED_INTEGER_LITERAL, APPROX_NUMERIC_LITERAL, DECIMAL_NUMERIC_LITERAL, SINGLE_QUOTED_STRING, DOUBLE_QUOTED_STRING);
    }

    static private final EnumSet<TokenType> first_set$mdx_ccc$722$3 = first_set$mdx_ccc$722$3_init();

    static private EnumSet<TokenType> first_set$mdx_ccc$722$3_init() {
        return tokenTypeSet(CASE, CAST, DIMENSION, NOT, NULL, PROPERTIES, EXISTING, LPAREN, LBRACE, MINUS, PLUS, ATSIGN, ID, QUOTED_ID, UNSIGNED_INTEGER_LITERAL, APPROX_NUMERIC_LITERAL, DECIMAL_NUMERIC_LITERAL, SINGLE_QUOTED_STRING, DOUBLE_QUOTED_STRING);
    }

    static private final EnumSet<TokenType> first_set$mdx_ccc$797$5$ = tokenTypeSet(DIMENSION, PROPERTIES, ATSIGN, ID, QUOTED_ID, AMP_QUOTED_ID, AMP_UNQUOTED_ID);
    static private final EnumSet<TokenType> first_set$mdx_ccc$797$5 = tokenTypeSet(DIMENSION, PROPERTIES, ATSIGN, ID, QUOTED_ID);
    static private final EnumSet<TokenType> first_set$mdx_ccc$871$5 = tokenTypeSet(DIMENSION, PROPERTIES);
    static private final EnumSet<TokenType> first_set$mdx_ccc$965$3 = first_set$mdx_ccc$965$3_init();

    static private EnumSet<TokenType> first_set$mdx_ccc$965$3_init() {
        return tokenTypeSet(CASE, CAST, DIMENSION, NULL, PROPERTIES, EXISTING, LPAREN, LBRACE, MINUS, PLUS, ATSIGN, ID, QUOTED_ID, UNSIGNED_INTEGER_LITERAL, APPROX_NUMERIC_LITERAL, DECIMAL_NUMERIC_LITERAL, SINGLE_QUOTED_STRING, DOUBLE_QUOTED_STRING);
    }

    static private final EnumSet<TokenType> first_set$mdx_ccc$987$5 = tokenTypeSet(EQ, GE, GT, LE, LT, NE);
    static private final EnumSet<TokenType> first_set$mdx_ccc$988$7 = tokenTypeSet(EQ, GE, GT, LE, LT, NE);
    static private final EnumSet<TokenType> first_set$mdx_ccc$1157$3 = first_set$mdx_ccc$1157$3_init();

    static private EnumSet<TokenType> first_set$mdx_ccc$1157$3_init() {
        return tokenTypeSet(CASE, CAST, DIMENSION, NULL, PROPERTIES, LPAREN, LBRACE, ATSIGN, ID, QUOTED_ID, UNSIGNED_INTEGER_LITERAL, APPROX_NUMERIC_LITERAL, DECIMAL_NUMERIC_LITERAL, SINGLE_QUOTED_STRING, DOUBLE_QUOTED_STRING);
    }

    static private final EnumSet<TokenType> first_set$mdx_ccc$1279$5 = first_set$mdx_ccc$1279$5_init();

    static private EnumSet<TokenType> first_set$mdx_ccc$1279$5_init() {
    ...
    static private final EnumSet<TokenType> first_set$mdx_ccc$1284$5 = first_set$mdx_ccc$1284$5_init();

    static private EnumSet<TokenType> first_set$mdx_ccc$1284$5_init() {
        return tokenTypeSet(CASE, CAST, DIMENSION, NOT, NULL, PROPERTIES, EXISTING, LPAREN, LBRACE, MINUS, PLUS, ATSIGN, ID, QUOTED_ID, UNSIGNED_INTEGER_LITERAL, APPROX_NUMERIC_LITERAL, DECIMAL_NUMERIC_LITERAL, SINGLE_QUOTED_STRING, DOUBLE_QUOTED_STRING);
    }

    static private final EnumSet<TokenType> first_set$mdx_ccc$1298$3 = tokenTypeSet(DIMENSION, PROPERTIES, ATSIGN, ID, QUOTED_ID);
    static private final EnumSet<TokenType> first_set$mdx_ccc$1338$5 = first_set$mdx_ccc$1338$5_init();

    static private EnumSet<TokenType> first_set$mdx_ccc$1338$5_init() {
        return tokenTypeSet(CASE, CAST, DIMENSION, NOT, NULL, PROPERTIES, EXISTING, LPAREN, LBRACE, MINUS, PLUS, ATSIGN, ID, QUOTED_ID, UNSIGNED_INTEGER_LITERAL, APPROX_NUMERIC_LITERAL, DECIMAL_NUMERIC_LITERAL, SINGLE_QUOTED_STRING, DOUBLE_QUOTED_STRING);
    }

    static private final EnumSet<TokenType> first_set$mdx_ccc$1421$5 = tokenTypeSet(AXIS, CHAPTERS, COLUMNS, PAGES, ROWS, SECTIONS, UNSIGNED_INTEGER_LITERAL);
    static private final EnumSet<TokenType> first_set$mdx_ccc$1422$7 = tokenTypeSet(AXIS, UNSIGNED_INTEGER_LITERAL);
    static private final EnumSet<TokenType> first_set$mdx_ccc$1443$5 = tokenTypeSet(CHAPTERS, COLUMNS, PAGES, ROWS, SECTIONS);
    static private final EnumSet<TokenType> first_set$mdx_ccc$1444$7 = tokenTypeSet(CHAPTERS, COLUMNS, PAGES, ROWS, SECTIONS);
    ...
    private final boolean check$mdx_ccc$703$5(boolean scanToEnd) {
        ...
        try {
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:703:5
            if (!scanToken(AS)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:703:12
            // NonTerminal parseIdentifier at ccc/mdx.ccc:703:12
            pushOntoLookaheadStack("parseExpression", "ccc/mdx.ccc", 703, 12);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:704:5
        } finally {
            lookaheadRoutineNesting--;
    ...
    // ccc/mdx.ccc:722:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$722$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:722:3
            // NonTerminal parseExpression at ccc/mdx.ccc:722:3
            pushOntoLookaheadStack("expressionOrEmpty", "ccc/mdx.ccc", 722, 3);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:723:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:727:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$727$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:727:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:746:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$746$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:746:5
            if (!scanToken(COMMA)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:747:5
            // NonTerminal expressionOrEmpty at ccc/mdx.ccc:747:5
            pushOntoLookaheadStack("expOrEmptyList", "ccc/mdx.ccc", 747, 5);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:748:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:769:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$769$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:769:5
            if (!scanToken(COMMA)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:770:5
            // NonTerminal parseExpression at ccc/mdx.ccc:770:5
            pushOntoLookaheadStack("expList", "ccc/mdx.ccc", 770, 5);
            currentLookaheadProduction = "parseExpression";
            try {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:771:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:797:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$797$5$(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:797:5
            // NonTerminal parseNameObjectIdentifier at ccc/mdx.ccc:797:5
            pushOntoLookaheadStack("parseIdentifier", "ccc/mdx.ccc", 797, 5);
    ...
    private final boolean check$mdx_ccc$799$5(boolean scanToEnd) {
        ...
        try {
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:799:5
            // NonTerminal parseKeyIdentifier at ccc/mdx.ccc:799:5
            pushOntoLookaheadStack("parseIdentifier", "ccc/mdx.ccc", 799, 5);
    ...
    // ccc/mdx.ccc:820:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$820$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:820:3
            if (!scanToken(ATSIGN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:820:14
            if (!scanToken(ID)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:821:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:911:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$911$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:911:5
            ...
            try {
                ...
                if (!check$mdx_ccc$911$5$(false)) {
                    ...
                    passedPredicate = false;
                    if (!check$mdx_ccc$918$5(false)) {
                        currentLookaheadToken = token2239;
                        remainingLookahead = remainingLookahead2239;
                        hitFailure = hitFailure2239;
                        if (passedPredicate && !legacyGlitchyLookahead) return false;
                        passedPredicate = false;
                        if (!check$mdx_ccc$927$5(false)) {
                            currentLookaheadToken = token2239;
                            remainingLookahead = remainingLookahead2239;
                            hitFailure = hitFailure2239;
                            return false;
    ...
    private final boolean check$mdx_ccc$911$5$(boolean scanToEnd) {
        ...
        try {
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:911:5
            if (!scanToken(OR)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:911:12
            // NonTerminal term5 at ccc/mdx.ccc:911:12
            pushOntoLookaheadStack("unaliasedExpression", "ccc/mdx.ccc", 911, 12);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:912:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:918:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$918$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:918:5
            if (!scanToken(XOR)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:918:13
            // NonTerminal term5 at ccc/mdx.ccc:918:13
            pushOntoLookaheadStack("unaliasedExpression", "ccc/mdx.ccc", 918, 13);
            currentLookaheadProduction = "term5";
            try {
                if (!check$term5(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:919:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:927:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$927$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:927:5
            if (!scanToken(COLON)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:927:15
            // NonTerminal term5 at ccc/mdx.ccc:927:15
            pushOntoLookaheadStack("unaliasedExpression", "ccc/mdx.ccc", 927, 15);
            currentLookaheadProduction = "term5";
            try {
                if (!check$term5(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:928:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:947:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$947$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:947:5
            if (!scanToken(AND)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:947:13
            // NonTerminal term4 at ccc/mdx.ccc:947:13
            pushOntoLookaheadStack("term5", "ccc/mdx.ccc", 947, 13);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:948:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:965:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$965$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:965:3
            // NonTerminal term3 at ccc/mdx.ccc:965:3
            pushOntoLookaheadStack("term4", "ccc/mdx.ccc", 965, 3);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:966:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:969:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$969$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:969:3
            if (!scanToken(NOT)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:969:11
            // NonTerminal term4 at ccc/mdx.ccc:969:11
            pushOntoLookaheadStack("term4", "ccc/mdx.ccc", 969, 11);
            currentLookaheadProduction = "term4";
            try {
                if (!check$term4(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:970:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:987:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$987$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:987:5
            ...
            try {
                passedPredicate = false;
                if (!check$mdx_ccc$987$5$(false)) {
                    currentLookaheadToken = token2264;
                    remainingLookahead = remainingLookahead2264;
                    hitFailure = hitFailure2264;
                    if (passedPredicate && !legacyGlitchyLookahead) return false;
                    passedPredicate = false;
                    if (!check$mdx_ccc$1023$5(false)) {
                        currentLookaheadToken = token2264;
                        remainingLookahead = remainingLookahead2264;
                        hitFailure = hitFailure2264;
                        if (passedPredicate && !legacyGlitchyLookahead) return false;
                        passedPredicate = false;
                        if (!check$mdx_ccc$1033$5(false)) {
                            currentLookaheadToken = token2264;
                            remainingLookahead = remainingLookahead2264;
                            hitFailure = hitFailure2264;
                            if (passedPredicate && !legacyGlitchyLookahead) return false;
                            passedPredicate = false;
                            if (!check$mdx_ccc$1041$5(false)) {
                                currentLookaheadToken = token2264;
                                remainingLookahead = remainingLookahead2264;
                                hitFailure = hitFailure2264;
                                if (passedPredicate && !legacyGlitchyLookahead) return false;
                                passedPredicate = false;
                                if (!check$mdx_ccc$1046$5(false)) {
                                    currentLookaheadToken = token2264;
                                    remainingLookahead = remainingLookahead2264;
                                    hitFailure = hitFailure2264;
                                    if (passedPredicate && !legacyGlitchyLookahead) return false;
                                    passedPredicate = false;
                                    if (!check$mdx_ccc$1053$5(false)) {
                                        currentLookaheadToken = token2264;
                                        remainingLookahead = remainingLookahead2264;
                                        hitFailure = hitFailure2264;
                                        if (passedPredicate && !legacyGlitchyLookahead) return false;
                                        passedPredicate = false;
                                        if (!check$mdx_ccc$1066$5(false)) {
                                            currentLookaheadToken = token2264;
                                            remainingLookahead = remainingLookahead2264;
                                            hitFailure = hitFailure2264;
                                            if (passedPredicate && !legacyGlitchyLookahead) return false;
                                            passedPredicate = false;
                                            if (!check$mdx_ccc$1073$5(false)) {
                                                currentLookaheadToken = token2264;
                                                remainingLookahead = remainingLookahead2264;
                                                hitFailure = hitFailure2264;
                                                return false;
    ...
    private final boolean check$mdx_ccc$987$5$(boolean scanToEnd) {
        ...
        try {
            ...
            // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:988:7
            if (!scanToken(first_set$mdx_ccc$988$7)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1013:5
            // NonTerminal term2 at ccc/mdx.ccc:1013:5
            pushOntoLookaheadStack("term3", "ccc/mdx.ccc", 1013, 5);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1014:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1023:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1023$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        ...
        try {
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1024:5
            if (!scanToken(IS)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1024:12
            if (!scanToken(NULL)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1025:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1033:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1033$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 2;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1034:5
            if (!scanToken(IS)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1034:12
            // NonTerminal term2 at ccc/mdx.ccc:1034:12
            pushOntoLookaheadStack("term3", "ccc/mdx.ccc", 1034, 12);
            currentLookaheadProduction = "term2";
            try {
                if (!check$term2(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1035:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1041:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1041$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1041:5
            if (!scanToken(IS)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1041:12
            if (!scanToken(EMPTY)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1042:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1046:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1046$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1046:5
            if (!scanToken(MATCHES)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1046:17
            // NonTerminal term2 at ccc/mdx.ccc:1046:17
            pushOntoLookaheadStack("term3", "ccc/mdx.ccc", 1046, 17);
            currentLookaheadProduction = "term2";
            try {
                if (!check$term2(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1047:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1053:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1053$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 2;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1054:5
            if (!scanToken(NOT)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1054:13
            if (!scanToken(MATCHES)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1054:25
            // NonTerminal term2 at ccc/mdx.ccc:1054:25
            pushOntoLookaheadStack("term3", "ccc/mdx.ccc", 1054, 25);
            currentLookaheadProduction = "term2";
            try {
                if (!check$term2(true)) return false;
            } finally {
    ...
    // ccc/mdx.ccc:1066:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1066$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1066:5
            if (!scanToken(IN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1066:12
            // NonTerminal term2 at ccc/mdx.ccc:1066:12
            pushOntoLookaheadStack("term3", "ccc/mdx.ccc", 1066, 12);
            currentLookaheadProduction = "term2";
            try {
                if (!check$term2(true)) return false;
            } finally {
    ...
    // ccc/mdx.ccc:1073:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1073$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1073:5
            if (!scanToken(NOT)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1073:13
            if (!scanToken(IN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1073:20
            // NonTerminal term2 at ccc/mdx.ccc:1073:20
            pushOntoLookaheadStack("term3", "ccc/mdx.ccc", 1073, 20);
            currentLookaheadProduction = "term2";
            try {
                if (!check$term2(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1074:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    private final boolean check$mdx_ccc$1098$5(boolean scanToEnd) {
        ...
        try {
            ...
            // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:1098:5
            ...
            try {
                ...
                if (!check$mdx_ccc$1098$5$(false)) {
                    ...
                    if (passedPredicate && !legacyGlitchyLookahead) return false;
                    passedPredicate = false;
                    if (!check$mdx_ccc$1105$5(false)) {
                        currentLookaheadToken = token2301;
                        remainingLookahead = remainingLookahead2301;
                        hitFailure = hitFailure2301;
                        if (passedPredicate && !legacyGlitchyLookahead) return false;
                        passedPredicate = false;
                        if (!check$mdx_ccc$1112$5(false)) {
                            currentLookaheadToken = token2301;
                            remainingLookahead = remainingLookahead2301;
                            hitFailure = hitFailure2301;
                            return false;
    ...
    private final boolean check$mdx_ccc$1098$5$(boolean scanToEnd) {
        ...
        try {
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1098:5
            if (!scanToken(PLUS)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1098:14
            // NonTerminal term at ccc/mdx.ccc:1098:14
            pushOntoLookaheadStack("term2", "ccc/mdx.ccc", 1098, 14);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1099:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1105:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1105$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1105:5
            if (!scanToken(MINUS)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1105:15
            // NonTerminal term at ccc/mdx.ccc:1105:15
            pushOntoLookaheadStack("term2", "ccc/mdx.ccc", 1105, 15);
            currentLookaheadProduction = "term";
            try {
                if (!check$term(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1106:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1112:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1112$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1112:5
            if (!scanToken(CONCAT)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1112:16
            // NonTerminal term at ccc/mdx.ccc:1112:16
            pushOntoLookaheadStack("term2", "ccc/mdx.ccc", 1112, 16);
            currentLookaheadProduction = "term";
            try {
                if (!check$term(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1113:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1132:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1132$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:1132:5
    ...
    private final boolean check$mdx_ccc$1132$5$(boolean scanToEnd) {
        ...
        try {
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1132:5
            if (!scanToken(ASTERISK)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1132:18
            // NonTerminal factor at ccc/mdx.ccc:1132:18
            pushOntoLookaheadStack("term", "ccc/mdx.ccc", 1132, 18);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1133:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    private final boolean check$mdx_ccc$1139$5(boolean scanToEnd) {
        ...
        try {
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1139:17
            // NonTerminal factor at ccc/mdx.ccc:1139:17
            pushOntoLookaheadStack("term", "ccc/mdx.ccc", 1139, 17);
            currentLookaheadProduction = "factor";
            try {
                if (!check$factor(true)) return false;
            } finally {
    ...
    // ccc/mdx.ccc:1157:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1157$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1157:3
            // NonTerminal primary at ccc/mdx.ccc:1157:3
            pushOntoLookaheadStack("factor", "ccc/mdx.ccc", 1157, 3);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1158:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1161:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1161$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1161:3
            if (!scanToken(PLUS)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1161:12
            // NonTerminal primary at ccc/mdx.ccc:1161:12
            pushOntoLookaheadStack("factor", "ccc/mdx.ccc", 1161, 12);
            currentLookaheadProduction = "primary";
            try {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1162:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1165:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1165$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1165:3
            if (!scanToken(MINUS)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1165:13
            // NonTerminal primary at ccc/mdx.ccc:1165:13
            pushOntoLookaheadStack("factor", "ccc/mdx.ccc", 1165, 13);
            currentLookaheadProduction = "primary";
            try {
                if (!check$primary(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1166:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1172:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1172$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1172:3
            if (!scanToken(EXISTING)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1172:16
            // NonTerminal primary at ccc/mdx.ccc:1172:16
            pushOntoLookaheadStack("factor", "ccc/mdx.ccc", 1172, 16);
            currentLookaheadProduction = "primary";
            try {
                if (!check$primary(true)) return false;
            } finally {
    ...
    // ccc/mdx.ccc:1188:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1188$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1188:5
            if (!scanToken(DOT)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1188:13
            // NonTerminal objectIdentifierOrFuncall at ccc/mdx.ccc:1188:13
            pushOntoLookaheadStack("primary", "ccc/mdx.ccc", 1188, 13);
    ...
    // ccc/mdx.ccc:1203:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1203$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1203:5
            if (!scanToken(LPAREN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:1205:7
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1212:5
    ...
    // ccc/mdx.ccc:1205:7
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1205$7(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        ...
        try {
            ...
            if (!check$mdx_ccc$1205$12(true)) return false;
            // End BuildPredicateCode macro
            $reachedScanCode$ = true;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1206:7
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1210:7
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1210$7(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1210:7
            // NonTerminal expOrEmptyList at ccc/mdx.ccc:1210:7
            pushOntoLookaheadStack("objectIdentifierOrFuncall", "ccc/mdx.ccc", 1210, 7);
    ...
    // ccc/mdx.ccc:1258:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1258$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1258:12
            if (!scanToken(LPAREN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1258:23
            // NonTerminal unaliasedExpression at ccc/mdx.ccc:1258:23
            pushOntoLookaheadStack("atom", "ccc/mdx.ccc", 1258, 23);
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1259:10
            // NonTerminal parseNameObjectIdentifier at ccc/mdx.ccc:1259:10
            pushOntoLookaheadStack("atom", "ccc/mdx.ccc", 1259, 10);
            currentLookaheadProduction = "parseNameObjectIdentifier";
            try {
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1259:59
            if (!scanToken(RPAREN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1260:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1268:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1268$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1268:3
            if (!scanToken(LPAREN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1268:14
            // NonTerminal expList at ccc/mdx.ccc:1268:14
            pushOntoLookaheadStack("atom", "ccc/mdx.ccc", 1268, 14);
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1268:36
            if (!scanToken(RPAREN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1269:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1277:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1277$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1277:3
            if (!scanToken(LBRACE)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:1279:5
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1286:3
            if (!scanToken(RBRACE)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1287:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1279:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1279$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 2147483647;
        try {
            lookaheadRoutineNesting++;
            ...
            if (!check$mdx_ccc$1279$10(true)) return false;
            // End BuildPredicateCode macro
            $reachedScanCode$ = true;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1280:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1284:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1284$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1284:5
            // NonTerminal expList at ccc/mdx.ccc:1284:5
            pushOntoLookaheadStack("atom", "ccc/mdx.ccc", 1284, 5);
            currentLookaheadProduction = "expList";
            try {
    ...
    // ccc/mdx.ccc:1291:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1291$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1291:3
            // NonTerminal caseExpression at ccc/mdx.ccc:1291:3
            pushOntoLookaheadStack("atom", "ccc/mdx.ccc", 1291, 3);
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1292:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1298:3
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1298$3(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1298:3
            // NonTerminal parseNameObjectIdentifier at ccc/mdx.ccc:1298:3
            pushOntoLookaheadStack("atom", "ccc/mdx.ccc", 1298, 3);
            currentLookaheadProduction = "parseNameObjectIdentifier";
            try {
                if (!check$parseNameObjectIdentifier(false)) return false;
            } finally {
            ...
            // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:1309:5
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1324:3
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1300:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1300$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1300:5
            if (!scanToken(BANG)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1300:14
            // NonTerminal parseNameObjectIdentifier at ccc/mdx.ccc:1300:14
            pushOntoLookaheadStack("atom", "ccc/mdx.ccc", 1300, 14);
            currentLookaheadProduction = "parseNameObjectIdentifier";
            try {
                if (!check$parseNameObjectIdentifier(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1301:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1309:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1309$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1309:5
            if (!scanToken(LPAREN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:1311:7
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1318:5
            if (!scanToken(RPAREN)) return false;
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
    ...
    // ccc/mdx.ccc:1311:7
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1311$7(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 2147483647;
        try {
            lookaheadRoutineNesting++;
            ...
            if (!check$mdx_ccc$1311$12(true)) return false;
            // End BuildPredicateCode macro
            $reachedScanCode$ = true;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1312:7
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1316:7
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1316$7(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1316:7
            // NonTerminal expOrEmptyList at ccc/mdx.ccc:1316:7
            pushOntoLookaheadStack("atom", "ccc/mdx.ccc", 1316, 7);
            currentLookaheadProduction = "expOrEmptyList";
            try {
                if (!check$expOrEmptyList(true)) return false;
            } finally {
    ...
    // ccc/mdx.ccc:1320:16
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1320$16(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1320:16
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1338:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1338$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1338:5
            // NonTerminal parseExpression at ccc/mdx.ccc:1338:5
            pushOntoLookaheadStack("caseExpression", "ccc/mdx.ccc", 1338, 5);
            currentLookaheadProduction = "parseExpression";
            try {
                if (!check$parseExpression(false)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1339:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1345:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1345$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1345:5
            if (!scanToken(WHEN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1345:14
            // NonTerminal parseExpression at ccc/mdx.ccc:1345:14
            pushOntoLookaheadStack("caseExpression", "ccc/mdx.ccc", 1345, 14);
            currentLookaheadProduction = "parseExpression";
            try {
                if (!check$parseExpression(true)) return false;
            } finally {
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1345:43
            if (!scanToken(THEN)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1345:52
            // NonTerminal parseExpression at ccc/mdx.ccc:1345:52
            pushOntoLookaheadStack("caseExpression", "ccc/mdx.ccc", 1345, 52);
            currentLookaheadProduction = "parseExpression";
            try {
                if (!check$parseExpression(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1346:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // ccc/mdx.ccc:1352:5
    // BuildScanRoutine macro
    private final boolean check$mdx_ccc$1352$5(boolean scanToEnd) {
        boolean $reachedScanCode$ = false;
        int passedPredicateThreshold = remainingLookahead - 1;
        try {
            lookaheadRoutineNesting++;
            ...
            // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1352:5
            if (!scanToken(ELSE)) return false;
            if (hitFailure) return false;
            if (remainingLookahead <= 0) {
                return true;
            }
            // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1352:14
            // NonTerminal parseExpression at ccc/mdx.ccc:1352:14
            pushOntoLookaheadStack("caseExpression", "ccc/mdx.ccc", 1352, 14);
            currentLookaheadProduction = "parseExpression";
            try {
                if (!check$parseExpression(true)) return false;
            } finally {
            ...
            // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1353:5
        } finally {
            lookaheadRoutineNesting--;
            if ($reachedScanCode$ && remainingLookahead <= passedPredicateThreshold) {
                passedPredicate = true;
    ...
    // BuildPredicateRoutine: expansion at ccc/mdx.ccc:891:5
    private final boolean scan$mdx_ccc$891$5() {
        ...
        try {
            ...
            if (!check$mdx_ccc$891$10(true)) return false;
            // End BuildPredicateCode macro
            return true;
        } finally {
    ...
    // BuildPredicateRoutine: expansion at ccc/mdx.ccc:1023:5
    private final boolean scan$mdx_ccc$1023$5() {
    ...
    // BuildPredicateRoutine: expansion at ccc/mdx.ccc:1033:5
    private final boolean scan$mdx_ccc$1033$5() {
        remainingLookahead = 2;
        currentLookaheadToken = lastConsumedToken;
        final boolean scanToEnd = false;
        try {
    ...
    // BuildPredicateRoutine: expansion at ccc/mdx.ccc:1053:5
    private final boolean scan$mdx_ccc$1053$5() {
        remainingLookahead = 2;
        currentLookaheadToken = lastConsumedToken;
        final boolean scanToEnd = false;
        try {
    ...
    // BuildPredicateRoutine: expansion at ccc/mdx.ccc:1205:7
    private final boolean scan$mdx_ccc$1205$7() {
        remainingLookahead = UNLIMITED;
        currentLookaheadToken = lastConsumedToken;
        final boolean scanToEnd = false;
        try {
    ...
    // BuildPredicateRoutine: expansion at ccc/mdx.ccc:1279:5
    private final boolean scan$mdx_ccc$1279$5() {
        remainingLookahead = UNLIMITED;
        currentLookaheadToken = lastConsumedToken;
        final boolean scanToEnd = false;
        try {
    ...
    // BuildPredicateRoutine: expansion at ccc/mdx.ccc:1311:7
    private final boolean scan$mdx_ccc$1311$7() {
        remainingLookahead = UNLIMITED;
        currentLookaheadToken = lastConsumedToken;
        final boolean scanToEnd = false;
        try {
    ...
    // ccc/mdx.ccc:891:5
    private final boolean check$mdx_ccc$891$10(boolean scanToEnd) {
    ...
    // lookahead routine for lookahead at:
    // ccc/mdx.ccc:1205:7
    private final boolean check$mdx_ccc$1205$12(boolean scanToEnd) {
        int prevRemainingLookahead = remainingLookahead;
        boolean prevHitFailure = hitFailure;
        Token prevScanAheadToken = currentLookaheadToken;
        try {
    ...
    // lookahead routine for lookahead at:
    // ccc/mdx.ccc:1279:5
    private final boolean check$mdx_ccc$1279$10(boolean scanToEnd) {
        int prevRemainingLookahead = remainingLookahead;
        boolean prevHitFailure = hitFailure;
        Token prevScanAheadToken = currentLookaheadToken;
        try {
    ...
    // lookahead routine for lookahead at:
    // ccc/mdx.ccc:1311:7
    private final boolean check$mdx_ccc$1311$12(boolean scanToEnd) {
        int prevRemainingLookahead = remainingLookahead;
        boolean prevHitFailure = hitFailure;
        Token prevScanAheadToken = currentLookaheadToken;
        try {
    ...
    private final boolean check$parseExpression(boolean scanToEnd) {
        ...
        // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:701:3
        // NonTerminal unaliasedExpression at ccc/mdx.ccc:701:3
        pushOntoLookaheadStack("parseExpression", "ccc/mdx.ccc", 701, 3);
        currentLookaheadProduction = "unaliasedExpression";
        try {
        ...
        // Lookahead Code for ZeroOrMore specified at ccc/mdx.ccc:702:3
        boolean passedPredicate2562 = passedPredicate;
        try {
            while (remainingLookahead > 0 && !hitFailure) {
                Token token2563 = currentLookaheadToken;
                passedPredicate = false;
                if (!check$mdx_ccc$703$5(false)) {
                    if (passedPredicate && !legacyGlitchyLookahead) return false;
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:712:3
        return true;
    }
    ...
    private final boolean check$expressionOrEmpty(boolean scanToEnd) {
        ...
        // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:722:3
    ...
    private final boolean check$expOrEmptyList(boolean scanToEnd) {
        ...
        // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:741:3
        // NonTerminal expressionOrEmpty at ccc/mdx.ccc:741:3
        pushOntoLookaheadStack("expOrEmptyList", "ccc/mdx.ccc", 741, 3);
        currentLookaheadProduction = "expressionOrEmpty";
        try {
            if (!check$expressionOrEmpty(true)) return false;
        } finally {
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:742:3
        if (hitFailure) return false;
        if (remainingLookahead <= 0) {
            return true;
        }
        // Lookahead Code for ZeroOrMore specified at ccc/mdx.ccc:745:3
        boolean passedPredicate2571 = passedPredicate;
        try {
            while (remainingLookahead > 0 && !hitFailure) {
                Token token2572 = currentLookaheadToken;
                passedPredicate = false;
                if (!check$mdx_ccc$746$5(false)) {
                    if (passedPredicate && !legacyGlitchyLookahead) return false;
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:752:3
        return true;
    }
    ...
    private final boolean check$expList(boolean scanToEnd) {
        ...
        // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:764:3
        // NonTerminal parseExpression at ccc/mdx.ccc:764:3
        pushOntoLookaheadStack("expList", "ccc/mdx.ccc", 764, 3);
        currentLookaheadProduction = "parseExpression";
        try {
            if (!check$parseExpression(false)) return false;
        } finally {
        ...
        // Lookahead Code for ZeroOrMore specified at ccc/mdx.ccc:768:3
        boolean passedPredicate2578 = passedPredicate;
        try {
            while (remainingLookahead > 0 && !hitFailure) {
                Token token2579 = currentLookaheadToken;
                passedPredicate = false;
                if (!check$mdx_ccc$769$5(false)) {
                    if (passedPredicate && !legacyGlitchyLookahead) return false;
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:775:3
        return true;
    }
    ...
    private final boolean check$parseIdentifier(boolean scanToEnd) {
        ...
        // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:797:5
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:801:3
        return true;
    }
    ...
    private final boolean check$parseNameObjectIdentifier(boolean scanToEnd) {
        ...
        // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:811:3
    ...
    private final boolean check$parseKeyIdentifier(boolean scanToEnd) {
        ...
        // Lookahead Code for OneOrMore specified at ccc/mdx.ccc:839:3
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:845:3
        return true;
    }
    ...
    private final boolean check$unaliasedExpression(boolean scanToEnd) {
        ...
        // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:909:3
        // NonTerminal term5 at ccc/mdx.ccc:909:3
        pushOntoLookaheadStack("unaliasedExpression", "ccc/mdx.ccc", 909, 3);
        currentLookaheadProduction = "term5";
        try {
        ...
        // Lookahead Code for ZeroOrMore specified at ccc/mdx.ccc:910:3
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:935:3
        return true;
    }
    ...
    private final boolean check$term5(boolean scanToEnd) {
        ...
        // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:945:3
        // NonTerminal term4 at ccc/mdx.ccc:945:3
        pushOntoLookaheadStack("term5", "ccc/mdx.ccc", 945, 3);
        currentLookaheadProduction = "term4";
        try {
        ...
        // Lookahead Code for ZeroOrMore specified at ccc/mdx.ccc:946:3
        boolean passedPredicate2616 = passedPredicate;
        try {
            while (remainingLookahead > 0 && !hitFailure) {
                Token token2617 = currentLookaheadToken;
                passedPredicate = false;
                if (!check$mdx_ccc$947$5(false)) {
                    if (passedPredicate && !legacyGlitchyLookahead) return false;
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:955:3
        return true;
    }
    ...
    private final boolean check$term4(boolean scanToEnd) {
        ...
        // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:965:3
    ...
    private final boolean check$term3(boolean scanToEnd) {
        ...
        // NonTerminal term2 at ccc/mdx.ccc:984:3
        pushOntoLookaheadStack("term3", "ccc/mdx.ccc", 984, 3);
        currentLookaheadProduction = "term2";
        try {
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1086:3
        return true;
    }
    ...
    private final boolean check$term2(boolean scanToEnd) {
        ...
        // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1096:3
        // NonTerminal term at ccc/mdx.ccc:1096:3
        pushOntoLookaheadStack("term2", "ccc/mdx.ccc", 1096, 3);
        currentLookaheadProduction = "term";
        try {
        ...
        // Lookahead Code for ZeroOrMore specified at ccc/mdx.ccc:1097:3
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1120:3
        return true;
    }
    ...
    private final boolean check$term(boolean scanToEnd) {
        ...
        // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1130:3
        // NonTerminal factor at ccc/mdx.ccc:1130:3
        pushOntoLookaheadStack("term", "ccc/mdx.ccc", 1130, 3);
        currentLookaheadProduction = "factor";
        try {
        ...
        // Lookahead Code for ZeroOrMore specified at ccc/mdx.ccc:1131:3
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1147:3
        return true;
    }
    ...
    private final boolean check$factor(boolean scanToEnd) {
        ...
        // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:1157:3
        ...
        try {
            passedPredicate = false;
            if (!check$mdx_ccc$1157$3(false)) {
                currentLookaheadToken = token2640;
                remainingLookahead = remainingLookahead2640;
                hitFailure = hitFailure2640;
                if (passedPredicate && !legacyGlitchyLookahead) return false;
                passedPredicate = false;
                if (!check$mdx_ccc$1161$3(false)) {
                    currentLookaheadToken = token2640;
                    remainingLookahead = remainingLookahead2640;
                    hitFailure = hitFailure2640;
                    if (passedPredicate && !legacyGlitchyLookahead) return false;
                    passedPredicate = false;
                    if (!check$mdx_ccc$1165$3(false)) {
                        currentLookaheadToken = token2640;
                        remainingLookahead = remainingLookahead2640;
                        hitFailure = hitFailure2640;
                        if (passedPredicate && !legacyGlitchyLookahead) return false;
                        passedPredicate = false;
                        if (!check$mdx_ccc$1172$3(false)) {
                            currentLookaheadToken = token2640;
                            remainingLookahead = remainingLookahead2640;
                            hitFailure = hitFailure2640;
                            return false;
    ...
    private final boolean check$primary(boolean scanToEnd) {
        ...
        // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1186:3
        // NonTerminal atom at ccc/mdx.ccc:1186:3
        pushOntoLookaheadStack("primary", "ccc/mdx.ccc", 1186, 3);
        ...
        // Lookahead Code for ZeroOrMore specified at ccc/mdx.ccc:1187:3
        boolean passedPredicate2644 = passedPredicate;
        try {
            while (remainingLookahead > 0 && !hitFailure) {
                Token token2645 = currentLookaheadToken;
                passedPredicate = false;
                if (!check$mdx_ccc$1188$5(false)) {
                    if (passedPredicate && !legacyGlitchyLookahead) return false;
        ...
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1190:3
        return true;
    }
    ...
    private final boolean check$objectIdentifierOrFuncall(boolean scanToEnd) {
        ...
        // Lookahead Code for NonTerminal specified at ccc/mdx.ccc:1201:3
        // NonTerminal parseIdentifier at ccc/mdx.ccc:1201:3
        pushOntoLookaheadStack("objectIdentifierOrFuncall", "ccc/mdx.ccc", 1201, 3);
        currentLookaheadProduction = "parseIdentifier";
        try {
        ...
        // Lookahead Code for ZeroOrOne specified at ccc/mdx.ccc:1202:3
        Token token2650 = currentLookaheadToken;
        boolean passedPredicate2650 = passedPredicate;
        passedPredicate = false;
        try {
            if (!check$mdx_ccc$1203$5(false)) {
                if (passedPredicate && !legacyGlitchyLookahead) return false;
    ...
    private final boolean check$atom(boolean scanToEnd) {
        ...
        // Lookahead Code for ExpansionChoice specified at ccc/mdx.ccc:1242:3
                ...
                if (!scanToken(DOUBLE_QUOTED_STRING)) {
                    ...
                    if (!scanToken(UNSIGNED_INTEGER_LITERAL, APPROX_NUMERIC_LITERAL, DECIMAL_NUMERIC_LITERAL)) {
                        ...
                        if (!scanToken(NULL)) {
                            ...
                            if (passedPredicate && !legacyGlitchyLookahead) return false;
                            passedPredicate = false;
                            if (!check$mdx_ccc$1258$3(false)) {
                                currentLookaheadToken = token2654;
                                remainingLookahead = remainingLookahead2654;
                                hitFailure = hitFailure2654;
                                if (passedPredicate && !legacyGlitchyLookahead) return false;
                                passedPredicate = false;
                                if (!check$mdx_ccc$1268$3(false)) {
                                    currentLookaheadToken = token2654;
                                    remainingLookahead = remainingLookahead2654;
                                    hitFailure = hitFailure2654;
                                    if (passedPredicate && !legacyGlitchyLookahead) return false;
                                    passedPredicate = false;
                                    if (!check$mdx_ccc$1277$3(false)) {
                                        currentLookaheadToken = token2654;
                                        remainingLookahead = remainingLookahead2654;
                                        hitFailure = hitFailure2654;
                                        if (passedPredicate && !legacyGlitchyLookahead) return false;
                                        passedPredicate = false;
                                        if (!check$mdx_ccc$1291$3(false)) {
                                            currentLookaheadToken = token2654;
                                            remainingLookahead = remainingLookahead2654;
                                            hitFailure = hitFailure2654;
                                            if (passedPredicate && !legacyGlitchyLookahead) return false;
                                            passedPredicate = false;
                                            if (!check$mdx_ccc$1298$3(false)) {
                                                currentLookaheadToken = token2654;
                                                remainingLookahead = remainingLookahead2654;
                                                hitFailure = hitFailure2654;
                                                return false;
    ...
    private final boolean check$caseExpression(boolean scanToEnd) {
        ...
        // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1336:3
        if (!scanToken(CASE)) return false;
        if (hitFailure) return false;
        if (remainingLookahead <= 0) {
            return true;
        }
        // Lookahead Code for ZeroOrOne specified at ccc/mdx.ccc:1337:3
        Token token2658 = currentLookaheadToken;
        boolean passedPredicate2658 = passedPredicate;
        passedPredicate = false;
        try {
            if (!check$mdx_ccc$1338$5(false)) {
                if (passedPredicate && !legacyGlitchyLookahead) return false;
        ...
        // Lookahead Code for ZeroOrMore specified at ccc/mdx.ccc:1344:3
        boolean passedPredicate2660 = passedPredicate;
        try {
            while (remainingLookahead > 0 && !hitFailure) {
                Token token2661 = currentLookaheadToken;
                passedPredicate = false;
                if (!check$mdx_ccc$1345$5(false)) {
                    if (passedPredicate && !legacyGlitchyLookahead) return false;
        ...
        // Lookahead Code for ZeroOrOne specified at ccc/mdx.ccc:1351:3
        Token token2663 = currentLookaheadToken;
        boolean passedPredicate2663 = passedPredicate;
        passedPredicate = false;
        try {
            if (!check$mdx_ccc$1352$5(false)) {
                if (passedPredicate && !legacyGlitchyLookahead) return false;
        ...
        // Lookahead Code for RegexpRef specified at ccc/mdx.ccc:1357:3
        if (!scanToken(END)) return false;
        if (hitFailure) return false;
        if (remainingLookahead <= 0) {
            return true;
        }
        // Lookahead Code for CodeBlock specified at ccc/mdx.ccc:1358:3
        return true;
    }
