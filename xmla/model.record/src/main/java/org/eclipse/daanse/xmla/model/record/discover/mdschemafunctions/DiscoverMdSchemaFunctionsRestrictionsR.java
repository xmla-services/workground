...
public record DiscoverMdSchemaFunctionsRestrictionsR(Optional<Integer> origin,
                                                     Optional<String> interfaceName,
                                                     Optional<String> libraryName) implements DiscoverMdSchemaFunctionsRestrictions {
