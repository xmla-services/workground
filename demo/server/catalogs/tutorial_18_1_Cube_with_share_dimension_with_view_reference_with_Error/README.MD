# Documentation
### CatalogName : tutorial_18_1_Cube_with_share_dimension_with_view_reference_with_Error
### Schema Cube_with_share_dimension_with hierarchy_with_view_reference_with_error : 
...
```
---
### Cube Matrix for Cube_with_share_dimension_with hierarchy_with_view_reference_with_error:
```mermaid
quadrantChart
title Cube Matrix
...
```
---
## Validation result for schema Cube_with_share_dimension_with hierarchy_with_view_reference_with_error
## <span style='color: red;'>ERROR</span> : 
|Type|   |
|----|---|
|DATABASE|Table "HT1" not found; SQL statement:select * from HT1 [42102-224]|
