...
public interface SqliteConfig {
	...
	default Integer defaultCacheSize() {
		return null;
	}
	...
	default Integer incrementalVacuum() {
		return null;
	}
	...
	default Integer jounalSizeLimit() {
		return null;
	}
	...
	default DatePrecision datePrecision() throws SQLException {
		return null;
	}
	...
	@AttributeDefinition(description = "milliseconds Connect to DB timeout in milliseconds")
	default Integer busyTimeout() {
		return null;
	}
