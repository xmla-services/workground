...
public class MemberPropertyDefinitionTest {

    @Test
    public void test1() throws MdxParserException {
        MemberPropertyDefinition memberPropertyDefinition =
            new MdxParserWrapper("[name] = [test]").parseMemberPropertyDefinition();
    ...
    public void test2() throws MdxParserException {
        MemberPropertyDefinition memberPropertyDefinition =
            new MdxParserWrapper("[name] = 9").parseMemberPropertyDefinition();
        assertThat(memberPropertyDefinition).isNotNull();
        assertThat(memberPropertyDefinition.objectIdentifier()).isInstanceOf(NameObjectIdentifier.class);
        NameObjectIdentifier nameObjectIdentifier1 = (NameObjectIdentifier) memberPropertyDefinition.objectIdentifier();
        assertThat(nameObjectIdentifier1.name()).isEqualTo("name");
    ...
    @Test
    public void test3() throws MdxParserException {
        MemberPropertyDefinition memberPropertyDefinition = new MdxParserWrapper("[name] = { expression1, expression2" +
    ...
    @Test
    public void test4() throws MdxParserException {
    ...
    @Test
    public void test5() throws MdxParserException {
        MemberPropertyDefinition memberPropertyDefinition =
            new MdxParserWrapper("[name] = [x].&bar").parseMemberPropertyDefinition();
        assertThat(memberPropertyDefinition).isNotNull();
        assertThat(memberPropertyDefinition.objectIdentifier()).isInstanceOf(NameObjectIdentifier.class);
        NameObjectIdentifier nameObjectIdentifier1 = (NameObjectIdentifier) memberPropertyDefinition.objectIdentifier();
        assertThat(nameObjectIdentifier1.name()).isEqualTo("name");
