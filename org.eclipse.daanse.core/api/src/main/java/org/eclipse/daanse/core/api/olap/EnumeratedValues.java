    ...
    implements Cloneable
{
    ...
    public EnumeratedValues<V> clone() {
        ...
        try {
            ...
            throw new RuntimeException("error while cloning " + this, ex);
        }
    ...
    public void register(V value) {
        ...
        Util.assertTrue(!isImmutable(), "isImmutable()");
        final String name = value.getName();
        Util.assertTrue(name != null, "value.getName() != null");
    ...
    public static class BasicValue implements Value {
        ...
        public BasicValue(String name, int ordinal, String description) {
            Util.assertTrue(name != null, "name != null");
            this.name = name;
