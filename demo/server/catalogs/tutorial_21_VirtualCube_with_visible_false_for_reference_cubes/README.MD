# Documentation
### CatalogName : tutorial_21_VirtualCube_with_visible_false_for_reference_cubes
...
```
---
## Validation result for schema Cube_with_virtual_cube_with_un_visible_reference_cube
