...
public interface Constants {
    ...
    QName QNAME_MSXMLA_DISCOVER = new QName("urn:schemas-microsoft-com:xml-analysis", "Discover");
    QName QNAME_MSXMLA_REQUESTTYPE = new QName("urn:schemas-microsoft-com:xml-analysis", "RequestType");
