...
public interface CubeAttributeBinding extends Binding {
    ...
    /**
     * @return Indicates the part of the Attribute to bind to.
     * Enumeration values are as
     * follows:
     * Element
     * Read-
     * Only
    ...
    /**
     * @return When the binding is to a collection of objects, the ordinal indicates
