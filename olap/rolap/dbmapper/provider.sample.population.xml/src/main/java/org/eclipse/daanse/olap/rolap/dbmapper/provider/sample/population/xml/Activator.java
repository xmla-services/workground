 ...
 *
 */
package org.eclipse.daanse.olap.rolap.dbmapper.provider.sample.population.xml;
...
public class Activator {
	...
	public void activate(BundleContext bc) throws IOException {
		...
		URL url = bc.getBundle().getEntry("/Population.xml");

		Dictionary<String, Object> ht = new Hashtable<>();
		ht.put("url", url.toString());
		ht.put("sample.name", "Population");
