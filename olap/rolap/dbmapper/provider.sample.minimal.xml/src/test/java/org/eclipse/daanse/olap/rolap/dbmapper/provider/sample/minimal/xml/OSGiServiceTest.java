...
class OSGiServiceTest {
    ...
    @org.junit.jupiter.api.Test
    void testDbMappingSchemaProviderWithProps(@InjectService(timeout = 1000,filter = "(&(sample.type=xml)(sample.name=Minimal))") DbMappingSchemaProvider provider) throws Exception {
        Schema schema = provider.get();
