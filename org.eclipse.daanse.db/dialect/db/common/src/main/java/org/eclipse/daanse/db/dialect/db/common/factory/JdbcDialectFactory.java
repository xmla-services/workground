...
package org.eclipse.daanse.db.dialect.db.common.factory;
...
/**
 * Implementation of {@link org.eclipse.daanse.db.dialect.api.DialectFactory} for subclasses
 * of {@link org.eclipse.daanse.db.dialect.db.common.JdbcDialectImpl}.
 *
...
public class JdbcDialectFactory implements DialectFactory {
        ...
        try {
            ...
            throw new RuntimeException(
                "Class does not contain constructor "
                    ...
                    + "for subclasses of JdbcDialectImpl", e);
        }
    }

    /**
     * Creates a temporary connection and calls
     * {@link org.eclipse.daanse.db.dialect.api.DialectFactory#createDialect(javax.sql.DataSource, java.sql.Connection)}.
     *
        ...
        DataSource dataSource)
    {
        ...
        try {
            ...
            //throw Util.newError(
            throw new RuntimeException(
                "Error while creating dialect", e);
        } finally {
            if (connection != null) {
                try {
                    connection.close();
