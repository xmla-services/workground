...
public class ParentChildHierarchyTest {
    ...
    public void testDotMembersNoClosure(Context context) {
        ((BaseTestContext)context).update(SchemaUpdater.createSubstitutingCube(
                "HR",
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testSnowflakeClosure(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testSharedClosureParentChildHierarchy(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testNonClosureParentChildHierarchy(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testChildrenOfAll(Context context) {
        assertQueryReturns(context.createConnection(),
            "select {[Measures].[Org Salary], [Measures].[Count]} on columns,\n"
     ...
     */
    public void testDistinctAll(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testDistinctChildrenOfAll(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testDistinctSubtree(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testDistinctAllExplicitClosure(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testDistinctChildrenOfAllExplicitClosure(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testDistinctSubtreeExplicitClosure(Context context) {
        getEmpClosureTestContext(context);
        assertQueryReturns(context.createConnection(),
            "select {[Measures].[Count], [Measures].[Org Salary], \n"
            + "[Measures].[Number Of Employees], [Measures].[Avg Salary]} on columns,\n"
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testLeaf(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testOneAboveLeaf(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testParentChildDescendantsLeavesBottom(Context context) {
        assertQueryReturns(context.createConnection(),
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testParentChildDescendantsLeavesTop(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testAllMembersParent(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testHierarchyFalseCycle(Context context) {
        if (Bug.avoidSlowTestOnLucidDB(getDialect(context.createConnection()))) {
            return;
        }
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testGenuineCycle(Context context) {
        Result result = executeQuery(context.createConnection(),
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testParentChildDrillThrough(Context context) {
        Result result = executeQuery(context.createConnection(),
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testParentChildDrillThroughWithContext(Context context) {
        Result result = executeQuery(context.createConnection(),
            "select {[Measures].Members} ON columns,\n"
            + "  {[Employees].Members} ON rows\n"
            + "from [HR]");
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testBugMondrian168(Context context) {
        assertQueryReturns(context.createConnection(),
            "select \n"
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testClosureTableInVirtualCube(Context context) {
        String baseSchema = TestUtil.getRawSchema(context);
        String schema = SchemaUtil.getSchema(baseSchema,
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testClosureVsNoClosure(Context context) {
        if (Bug.avoidSlowTestOnLucidDB(getDialect(context.createConnection()))) {
            return;
        }
        String cubestart =
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testSchemaReaderLevelMembers(Context context)
    {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testBridgeTable(Context context) {
    ...
    @ParameterizedTest
    @ContextSource(propertyUpdater = AppandFoodMartCatalogAsFile.class, dataloader = FastFoodmardDataLoader.class)
    public void testPCCacheKeyBug(Context context) throws Exception {
        final String mdx =
            "With\n"
