...
public class TraceConvertor {
    ...
    private static TraceFilter convertTraceFilter(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.TraceFilter filter) {
        if (filter != null) {
    ...
    private static EventColumnID convertEventColumnID(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.EventColumnID columns) {
        if (columns != null) {
    ...
    private static EventSession convertEventSession(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.EventSession eventSession) {
    ...
    private static PartitionModes convertPartitionModes(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PartitionModes memoryPartitionMode) {
    ...
    private static RetentionModes convertRetentionModes(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.RetentionModes eventRetentionMode) {
