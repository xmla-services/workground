...
public class SelectQueryAxisClauseTest {

    @Test
    public void test1() throws MdxParserException {
        SelectQueryAxisClause selectQueryAxisClause = new MdxParserWrapper("[Customer].[Gender].[Gender].Membmers ON " +
            "COLUMNS").parseSelectQueryAxisClause();
    ...
    public void test2() throws MdxParserException {
        SelectQueryAxisClause selectQueryAxisClause =
            new MdxParserWrapper("{[Customer].[Customer].[Aaron A. Allen], [Customer].[Customer].[Abigail Clark]} ON " +
                "ROWS")
    ...
    public static void checkSelectQueryAxisClause1(SelectQueryAxisClause selectQueryAxisClause) {
        ...
        assertThat(selectQueryAxisClause.axis().named()).isEqualTo(true);
