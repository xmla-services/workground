...
public interface Dialect {
	 ...
	 *
	 * <ul>
	 * <li>"foo.bar" -> "UPPER(foo.bar)"</li>
	 * <li>"foo.bar" -> "UCASE(foo.bar)"</li>
	 * <ul>
	 *
	 ...
	 * call.
	 * <ul>
	 * <li>"case when ifValue then thenValue else elseValue end"</li>
	 * <li>""Iif( ifValue , thenValue, elseValue)</li>
	 * <ul>
	 * <p>
	 *
	 * 
	 ...
	 * double-quotes, <code>quoteIdentifier("schema","table")</code> yields a string
	 * containing <code>"schema"."table"</code>.
	 *
	 * @param qual Qualifier. If it is not null, <code>"<em>qual</em>".</code> is
	 *             prepended.
	 ...
	 * <code>quoteStringLiteral(buf, "Can't")</code> appends "<code>'Can''t'</code>"
	 * to <code>buf</code>.
	 *
	 ...
	 * <p>
	 * For example, in the default dialect,
	 * <code>quoteDecimalLiteral(buf, "12.58")</code> appends
	 * <code>FLOAT('12.58') for DB2</code>.
	 *
	 * @param value Literal
	 */
	 ...
	 * </blockquote> gives "Multiple DISTINCT aggregates are not supported at this
	 * time."
	 *
	 ...
	 * values, depending on the <code>collateNullsLast</code> parameter.
	 *
	 ...
	 * <code>SELECT CONCAT(x) as foo FROM t HAVING foo LIKE "%"</code> </blockquote>
	 *
	 * would be legal.
	 * </p>
	 *
