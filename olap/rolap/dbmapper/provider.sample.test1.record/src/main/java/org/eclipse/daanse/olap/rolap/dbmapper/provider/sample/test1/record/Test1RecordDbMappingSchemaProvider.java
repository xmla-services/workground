 ...
 *
 */
package org.eclipse.daanse.olap.rolap.dbmapper.provider.sample.test1.record;
...
@Component(service = DbMappingSchemaProvider.class, scope = ServiceScope.SINGLETON, property = {"sample.name=Test1",
    "sample.type=record"})
public class Test1RecordDbMappingSchemaProvider implements DbMappingSchemaProvider {
    ...
    private static final TableR TABLE_FACT = new TableR("TestCubeFact");
