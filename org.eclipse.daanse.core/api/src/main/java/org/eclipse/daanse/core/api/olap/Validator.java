...
public interface Validator {
    /**
     * Returns the {@link IQuery} which is being validated.
     */
    IQuery getQuery();
     ...
     */
    void validate(Exp parameterExpr);
     ...
     * <p>It must resolve to the same object (although sub-objects may change).
     */
    void validate(IMemberProperty memberProperty);
     ...
     * It must resolve to the same object (although sub-objects may change).
     */
    void validate(IFormula formula);
