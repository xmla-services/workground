...
public class mdxLexer extends TokenSource<Token> {
    ...
    */
    private static class DEFAULT {
        ...
        static private TokenType NFA_0(int ch, BitSet nextStates, EnumSet<TokenType> validTypes) {
            ...
            } else if (((ch == '$') || ((ch >= 'A' && ch <= 'Z') || ((ch == '_') || (ch >= 'a' && ch <= 'z')))) || (ch >= 128 && checkIntervals(NFA_MOVES_512, ch))) {
                nextStates.set(36);
        ...
        static private TokenType NFA_11(int ch, BitSet nextStates, EnumSet<TokenType> validTypes) {
            TokenType type = null;
            if (((ch == '$') || ((ch >= 'A' && ch <= 'Z') || ((ch == '_') || (ch >= 'a' && ch <= 'z')))) || (ch >= 128 && checkIntervals(NFA_MOVES_354, ch))) {
                nextStates.set(11);
                if (validTypes.contains(AMP_UNQUOTED_ID)) type = AMP_UNQUOTED_ID;
            }
            if ((ch >= '0' && ch <= '9') || (ch >= 128 && checkIntervals(NFA_MOVES_276, ch))) {
                nextStates.set(11);
                if (validTypes.contains(AMP_UNQUOTED_ID)) type = AMP_UNQUOTED_ID;
            }
            return type;
        ...
        static private TokenType NFA_36(int ch, BitSet nextStates, EnumSet<TokenType> validTypes) {
            TokenType type = null;
            if (((ch == '$') || ((ch >= 'A' && ch <= 'Z') || ((ch == '_') || (ch >= 'a' && ch <= 'z')))) || (ch >= 128 && checkIntervals(NFA_MOVES_414, ch))) {
                nextStates.set(36);
                if (validTypes.contains(ID)) type = ID;
            }
            if ((ch >= '0' && ch <= '9') || (ch >= 128 && checkIntervals(NFA_MOVES_511, ch))) {
                nextStates.set(36);
                if (validTypes.contains(ID)) type = ID;
            }
            return type;
        ...
        static private int[] NFA_MOVES_276 = NFA_MOVES_276_init();

        static private int[] NFA_MOVES_276_init() {
        ...
        static private int[] NFA_MOVES_354 = NFA_MOVES_354_init();

        static private int[] NFA_MOVES_354_init() {
        ...
        static private int[] NFA_MOVES_414 = NFA_MOVES_414_init();

        static private int[] NFA_MOVES_414_init() {
            return new int[] {'$', '$', 'A', 'Z', '_', '_', 'a', 'z', 0xc0, 0xd6,
            0xd8, 0xf6, 0xf8, 0x1fff, 0x2c62, 0x2c66, 0x2c6d, 0x2c70, 0x2c7e, 0x2c7f,
            0x2d00, 0x2d25, 0x2d27, 0x2d27, 0x2d2d, 0x2d2d, 0x3040, 0x318f, 0x3300,
            0x337f, 0x3400, 0x3d2d, 0x4e00, 0x9fff, 0xa64a, 0xa64a, 0xa77d, 0xa77d,
        ...
        static private int[] NFA_MOVES_511 = NFA_MOVES_511_init();

        static private int[] NFA_MOVES_511_init() {
            return new int[] {'0', '9', 0x660, 0x669, 0x6f0, 0x6f9, 0x966, 0x96f,
            0x9e6, 0x9ef, 0xa66, 0xa6f, 0xae6, 0xaef, 0xb66, 0xb6f, 0xbe7, 0xbef,
            0xc66, 0xc6f, 0xce6, 0xcef, 0xd66, 0xd6f, 0xe50, 0xe59, 0xed0, 0xed9,
            0x1040, 0x1049};
        ...
        static private int[] NFA_MOVES_512 = NFA_MOVES_512_init();

        static private int[] NFA_MOVES_512_init() {
            return new int[] {'$', '$', 'A', 'Z', '_', '_', 'a', 'z', 0xc0, 0xd6,
            0xd8, 0xf6, 0xf8, 0x1fff, 0x2c62, 0x2c66, 0x2c6d, 0x2c70, 0x2c7e, 0x2c7f,
            0x2d00, 0x2d25, 0x2d27, 0x2d27, 0x2d2d, 0x2d2d, 0x3040, 0x318f, 0x3300,
            0x337f, 0x3400, 0x3d2d, 0x4e00, 0x9fff, 0xa64a, 0xa64a, 0xa77d, 0xa77d,
