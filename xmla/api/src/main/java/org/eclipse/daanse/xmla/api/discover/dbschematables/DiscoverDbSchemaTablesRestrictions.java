 ...
 */
package org.eclipse.daanse.xmla.api.discover.dbschematables;

import java.util.Optional;

public interface DiscoverDbSchemaTablesRestrictions {
    String RESTRICTIONS_TABLE_CATALOG = "TABLE_CATALOG";
    String RESTRICTIONS_TABLE_SCHEMA = "RESTRICTIONS_TABLE_SCHEMA";
