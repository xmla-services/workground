...
import static org.eclipse.daanse.xmla.server.jakarta.jws.BindingConvertor.convertBindingList;
import static org.eclipse.daanse.xmla.server.jakarta.jws.CommandConvertor.convertCommandList;
...
import static org.eclipse.daanse.xmla.server.jakarta.jws.TabularBindingConvertor.convertTabularBinding;
...
import org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.DrillThroughAction;
import org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ReportAction;
import org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.StandardAction;
...
public class CubeConvertor {
	...
	public static Cube convertCube(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Cube cube) {
		if (cube != null) {
	...
	private static DataSourceViewBinding convertDataSourceViewBinding(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.DataSourceViewBinding source) {
		if (source != null) {
	...
	private static List<MeasureGroup> convertMeasureGroupList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.MeasureGroup> measureGroup) {
	...
	public static MeasureGroup convertMeasureGroup(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.MeasureGroup measureGroup) {
		if (measureGroup != null) {
	...
	public static MeasureGroupBinding convertMeasureGroupBinding(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.MeasureGroupBinding source) {
		if (source != null) {
	...
	private static List<Partition> convertPartitionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Partition> partitionList) {
	...
	public static Partition convertPartition(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Partition partition) {
		if (partition != null) {
	...
	private static List<AggregationInstance> convertAggregationInstanceList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationInstance> aggregationInstanceList) {
	...
	private static AggregationInstance convertAggregationInstance(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationInstance aggregationInstance) {
	...
	private static List<AggregationInstanceMeasure> convertAggregationInstanceMeasureList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationInstanceMeasure> measureList) {
		if (measureList != null) {
	...
	private static AggregationInstanceMeasure convertAggregationInstanceMeasure(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationInstanceMeasure aggregationInstanceMeasure) {
	...
	private static ColumnBinding convertColumnBinding(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ColumnBinding source) {
		if (source != null) {
	...
	private static List<AggregationInstanceDimension> convertAggregationInstanceDimensionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationInstanceDimension> dimensionList) {
	...
	private static AggregationInstanceDimension convertAggregationInstanceDimension(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationInstanceDimension aggregationInstanceDimension) {
	...
	private static List<AggregationInstanceAttribute> convertAggregationInstanceAttributeList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationInstanceAttribute> attributeList) {
	...
	private static AggregationInstanceAttribute convertAggregationInstanceAttribute(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationInstanceAttribute aggregationInstanceAttribute) {
	...
	private static Partition.CurrentStorageMode convertPartitionCurrentStorageMode(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Partition.CurrentStorageMode currentStorageMode) {
	...
	private static Partition.StorageMode convertPartitionStorageMode(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Partition.StorageMode storageMode) {
		if (storageMode != null) {
	...
	private static List<MeasureGroupDimension> convertMeasureGroupDimensionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.MeasureGroupDimension> dimensionList) {
		if (dimensionList != null) {
	...
	private static MeasureGroup.StorageMode convertMeasureGroupStorageMode(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.MeasureGroup.StorageMode storageMode) {
		if (storageMode != null) {
	...
	private static List<Measure> convertMeasureList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Measure> measureList) {
		if (measureList != null) {
	...
	private static Measure convertMeasure(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Measure measure) {
		if (measure != null) {
	...
	private static List<AggregationDesign> convertaggregationDesignList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationDesign> aggregationDesignList) {
	...
	private static AggregationDesign convertAggregationDesign(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationDesign aggregationDesign) {
	...
	private static List<Aggregation> convertAggregationList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Aggregation> aggregationList) {
	...
	private static Aggregation convertAggregation(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Aggregation aggregation) {
		if (aggregation != null) {
	...
	private static List<AggregationDimension> convertAggregationDimensionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationDimension> dimensionList) {
		if (dimensionList != null) {
	...
	private static AggregationDimension convertAggregationDimension(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationDimension aggregationDimension) {
	...
	private static List<AggregationAttribute> convertAggregationAttributList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationAttribute> attributeList) {
		if (attributeList != null) {
	...
	private static AggregationAttribute convertAggregationAttribute(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationAttribute aggregationAttribute) {
	...
	private static List<AggregationDesignDimension> convertAggregationDesignDimensionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationDesignDimension> dimension) {
		if (dimension != null) {
	...
	private static AggregationDesignDimension convertAggregationDesignDimension(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationDesignDimension aggregationDesignDimension) {
	...
	private static List<AggregationDesignAttribute> convertAggregationDesignAttributeList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationDesignAttribute> attributeList) {
		if (attributeList != null) {
	...
	private static AggregationDesignAttribute convertAggregationDesignAttribute(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AggregationDesignAttribute aggregationDesignAttribute) {
	...
	private static Cube.StorageMode convertCubeStorageMode(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Cube.StorageMode storageMode) {
		if (storageMode != null) {
	...
	public static ProactiveCaching convertProactiveCaching(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ProactiveCaching proactiveCaching) {
	...
	private static ProactiveCachingBinding convertProactiveCachingBinding(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ProactiveCachingBinding source) {
		if (source != null) {
			if (source instanceof org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ProactiveCachingQueryBinding proactiveCachingQueryBinding) {
			...
			if (source instanceof org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ProactiveCachingIncrementalProcessingBinding proactiveCachingIncrementalProcessingBinding) {
	...
	private static List<IncrementalProcessingNotification> convertIncrementalProcessingNotificationList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.IncrementalProcessingNotification> incrementalProcessingNotificationList) {
	...
	private static IncrementalProcessingNotification convertIncrementalProcessingNotification(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.IncrementalProcessingNotification incrementalProcessingNotification) {
	...
	private static List<QueryNotification> convertQueryNotificationList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.QueryNotification> queryNotificationList) {
	...
	private static QueryNotification convertQueryNotification(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.QueryNotification queryNotification) {
	...
	private static List<Kpi> convertKpiList(List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Kpi> kpiList) {
		if (kpiList != null) {
	...
	private static Kpi convertKpi(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Kpi kpi) {
		if (kpi != null) {
	...
	private static List<Action> convertActionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Action> actionList) {
		if (actionList != null) {
	...
	private static Action convertAction(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Action action) {
		if (action != null) {
			if (action instanceof org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.StandardAction standardAction) {

			    return convertStandardAction(standardAction);
			}
			if (action instanceof org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ReportAction reportAction) {

                return convertReportAction(reportAction);
			}
			if (action instanceof org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.DrillThroughAction drillThroughAction) {
    ...
    private static List<ReportFormatParameter> convertReportFormatParameterList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ReportFormatParameter> list) {
		if (list != null) {
	...
	private static ReportFormatParameter convertReportFormatParameter(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ReportFormatParameter reportFormatParameter) {
	...
	private static List<ReportParameter> convertReportParametersList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ReportParameter> list) {
		if (list != null) {
	...
	private static ReportParameter convertReportParameter(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.ReportParameter reportParameter) {
	...
	private static List<Perspective> convertPerspectiveList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Perspective> perspectiveList) {
	...
	public static Perspective convertPerspective(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Perspective perspective) {
		if (perspective != null) {
	...
	private static List<PerspectiveKpi> convertPerspectiveKpiList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveKpi> kpiList) {
		if (kpiList != null) {
	...
	private static PerspectiveKpi convertPerspectiveKpi(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveKpi perspectiveKpi) {
	...
	private static List<PerspectiveCalculation> convertPerspectiveCalculationList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveCalculation> calculationList) {
	...
	private static PerspectiveCalculation convertPerspectiveCalculation(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveCalculation perspectiveCalculation) {
	...
	private static List<PerspectiveAction> convertPerspectiveActionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveAction> actionList) {
		if (actionList != null) {
	...
	private static PerspectiveAction convertPerspectiveAction(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveAction perspectiveAction) {
	...
	private static List<PerspectiveMeasureGroup> convertPerspectiveMeasureGroupList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveMeasureGroup> measureGroupList) {
	...
	private static PerspectiveMeasureGroup convertPerspectiveMeasureGroup(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveMeasureGroup perspectiveMeasureGroup) {
	...
	private static List<PerspectiveMeasure> convertPerspectiveMeasureList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveMeasure> measureList) {
		if (measureList != null) {
	...
	private static PerspectiveMeasure convertPerspectiveMeasure(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveMeasure perspectiveMeasure) {
	...
	private static List<PerspectiveDimension> convertPerspectiveDimensionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveDimension> dimensionList) {
		if (dimensionList != null) {
	...
	private static PerspectiveDimension convertPerspectiveDimension(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveDimension perspectiveDimension) {
	...
	private static List<PerspectiveHierarchy> convertPerspectiveHierarchyList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveHierarchy> hierarchyList) {
	...
	private static PerspectiveHierarchy convertPerspectiveHierarchy(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveHierarchy perspectiveHierarchy) {
	...
	private static List<PerspectiveAttribute> convertPerspectiveAttributeList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveAttribute> attributeList) {
		if (attributeList != null) {
	...
	private static PerspectiveAttribute convertPerspectiveAttribute(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.PerspectiveAttribute perspectiveAttribute) {
	...
	private static List<MdxScript> convertMdxScriptList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.MdxScript> mdxScriptList) {
	...
	public static MdxScript convertMdxScript(org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.MdxScript mdxScript) {
		if (mdxScript != null) {
	...
	private static List<CalculationProperty> convertCalculationPropertyList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CalculationProperty> calculationPropertyList) {
	...
	private static CalculationProperty convertCalculationProperty(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CalculationProperty calculationProperty) {
	...
	private static CalculationPropertiesVisualizationProperties convertCalculationPropertiesVisualizationProperties(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.engine300.CalculationPropertiesVisualizationProperties visualizationProperties) {
	...
	private static List<CubePermission> convertCubePermissionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubePermission> cubePermissionList) {
	...
	private static CubePermission convertCubePermission(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubePermission cubePermission) {
	...
	private static List<CubeDimensionPermission> convertCubeDimensionPermissionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubeDimensionPermission> dimensionPermissionList) {
	...
	public static CubeDimensionPermission convertCubeDimensionPermission(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubeDimensionPermission cubeDimensionPermission) {
	...
	public static List<AttributePermission> convertAttributePermissionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AttributePermission> attributePermissionList) {
	...
	private static AttributePermission convertAttributePermission(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.AttributePermission attributePermission) {
	...
	private static List<CellPermission> convertCellPermissionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CellPermission> cellPermissionList) {
	...
	private static CellPermission convertCellPermission(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CellPermission cellPermission) {
	...
	private static List<CubeDimension> convertDimensionList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubeDimension> dimensionList) {
		if (dimensionList != null) {
	...
	public static CubeDimension convertCubeDimension(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubeDimension cubeDimension) {
	...
	private static List<CubeHierarchy> convertCubeHierarchyList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubeHierarchy> hierarchy) {
		if (hierarchy != null) {
	...
	private static CubeHierarchy convertCubeHierarchy(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubeHierarchy cubeHierarchy) {
	...
	private static List<CubeAttribute> convertCubeAttributeList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubeAttribute> attributeList) {
		if (attributeList != null) {
	...
	private static CubeAttribute convertCubeAttribute(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.CubeAttribute cubeAttribute) {
	...
	public static List<Translation> convertTranslationList(
			List<org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Translation> translationList) {
	...
	private static Translation convertTranslation(
			org.eclipse.daanse.xmla.model.jakarta.xml.bind.xmla.Translation translation) {
		if (translation != null) {
